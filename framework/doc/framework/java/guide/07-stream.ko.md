...
- client connector 상세: [stream-connector](../../common/spec/languages/java/03-stream-connector.ko.md)
- 서버 정식 계약: [spring-boot-stream](../../common/spec/languages/java/01-system-structure.ko.md)
