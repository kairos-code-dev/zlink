...
다룬다. 특정 언어에서 쓰는 법은 [언어별 바인딩 가이드](../../../bindings/doc/guide/README.ko.md)를
본다.
...
| **특정 언어로 쓴다** | [바인딩 가이드](../../../bindings/doc/guide/README.ko.md)로 바로 가서, 막히는 개념만 이 가이드로 |
...
> **언어별 사용 가이드**: [.NET](../../../bindings/doc/guide/dotnet/index.ko.md) 등은
> [바인딩 가이드 목록](../../../bindings/doc/guide/README.ko.md)에서 고른다. 개념은 이 코어 가이드가
