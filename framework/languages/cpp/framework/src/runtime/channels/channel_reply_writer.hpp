...
class channel_reply_writer_t
{
  public:
    ...
    runtime::messaging::envelope_header_t create_error_header (std::string channel_name,
                                                               const runtime::messaging::envelope_header_t &request,
                                                               const framework_exception_t &error) const;

    runtime::messaging::message_parts_t reply_raw_envelope (const runtime::messaging::envelope_header_t &header,
