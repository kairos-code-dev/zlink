...
dependencies {
    ...
    implementation("systems.zlink:zlink-stream-connector-json:0.1.0-SNAPSHOT")
...
application {
    mainClass.set("systems.zlink.samples.kotlin.deliverydispatch.server.session.ProgramKt")
