...
> POSD 리뷰 등급: **B-** — 측정 의미/RESULT 포맷/retry 금지 등 핵심 계약 준수 양호,
> 그러나 internal API 사용, hot path mutex, snapshot polling ready gate,
> start gate sleep, 과대 모듈 등 구조적 문제 다수
...
- `bench_common.hpp`가 400줄 이하로 축소됨
