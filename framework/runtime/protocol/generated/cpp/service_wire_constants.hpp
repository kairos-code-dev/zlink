...
inline constexpr std::uint64_t transferReferenceBytes = 4096ULL;
...
inline constexpr std::uint64_t transferChunkBytes = 67108864ULL;
inline constexpr std::uint64_t transferChunkEnvelopeBytes = 67108886ULL;
inline constexpr std::uint64_t transferChunkCount = 4096ULL;
inline constexpr std::uint64_t transferLogicalBytes = 274877906944ULL;
inline constexpr std::uint64_t transferManifestBytes = 33554432ULL;
...
inline constexpr std::uint64_t routeForwardBytes = 16777216ULL;
