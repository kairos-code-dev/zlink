...
| `4x` | [40 Location runtime](server/40-location-runtime.ko.md) · [41 Redis Location Store](server/41-location-store-redis.ko.md) · [42 Redis Relocation Store](server/42-relocation-store-redis.ko.md) |
