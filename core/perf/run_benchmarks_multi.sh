...
MODE="${BENCH_MODE:-observe}"
ROLLING_N="${BENCH_ROLLING_N:-10}"
BASELINE_FILE="${BENCH_BASELINE_FILE:-}"
WARN_THROUGHPUT_PCT="${BENCH_WARN_THROUGHPUT_PCT:-10}"
FAIL_THROUGHPUT_PCT="${BENCH_FAIL_THROUGHPUT_PCT:-15}"
WARN_LATENCY_PCT="${BENCH_WARN_LATENCY_PCT:-10}"
FAIL_LATENCY_PCT="${BENCH_FAIL_LATENCY_PCT:-15}"
...
MULTI_TRANSPORT_TRANSITION_MS="${BENCH_MULTI_TRANSPORT_TRANSITION_MS:-3000}"
MULTI_PATTERN_TRANSITION_MS="${BENCH_MULTI_PATTERN_TRANSITION_MS:-3000}"
MULTI_SERVER_READY_TIMEOUT_MS="${BENCH_MULTI_SERVER_READY_TIMEOUT_MS:-10000}"
MULTI_CONNECT_READY_TIMEOUT_MS="${BENCH_MULTI_CONNECT_READY_TIMEOUT_MS:-5000}"
MULTI_MONITOR_HWM="${BENCH_MULTI_MONITOR_HWM:-200000}"
MULTI_SERVER_SHUTDOWN_TIMEOUT_MS="${BENCH_MULTI_SERVER_SHUTDOWN_TIMEOUT_MS:-5000}"
MULTI_SERVER_BIND_PORT="${BENCH_MULTI_SERVER_BIND_PORT:-0}"
RESULTS_DIR_OVERRIDE="${BENCH_RESULTS_DIR:-}"
EXPLICIT_PATTERNS=()
SCRIPT_ARGS=()
...
if [[ "${HAS_EXPLICIT_RESULTS_DIR}" -eq 0 && -n "${BENCH_RESULTS_DIR:-}" ]]; then
  RUN_ENV+=(BENCH_RESULTS_DIR="${BENCH_RESULTS_DIR}")
fi
