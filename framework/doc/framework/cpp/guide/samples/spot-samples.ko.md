...
[문서 목록](../../../../README.ko.md) | [이전: C++ Interface Contract](../../../common/spec/languages/cpp/handler-interfaces.ko.md) | [다음: C++ Stage Wrapper On SPOT](../../../common/spec/languages/cpp/stage-wrapper-on-spot.ko.md)
<!-- framework-adapter-nav:end -->

[스펙 목차](../../../common/README.ko.md)

[C++ 묶음](../../README.ko.md) | [Framework 인터페이스](../../../common/spec/languages/cpp/cpp-framework-interfaces.ko.md) | [SPOT](../../../common/spec/languages/cpp/cpp-spot.ko.md)

# ZLink Framework C++ SPOT Samples

이 문서는 현재 C++ public API를 사용하는 SpotNode, Spot handler와 actor 예제를
설명한다. 공개 계약은 [Spot spec](../../../common/spec/languages/cpp/cpp-spot.ko.md)이 소유한다.
