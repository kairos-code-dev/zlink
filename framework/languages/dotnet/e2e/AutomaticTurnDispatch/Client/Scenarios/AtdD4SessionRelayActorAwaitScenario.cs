...
internal static class AtdD4SessionRelayActorAwaitScenario
{
        ...
        AwaitActorScenarioContext actors)
    {
        ...
        var requestId = $"ATD-D4-{Guid.NewGuid():N}";
        ...
        ScenarioAssert.That(reply.ScenarioId == "ATD-D4", "ATD-D4 reply scenario mismatch.");
        ScenarioAssert.That(notify.Payload.ActorId == actors.ActorA, "ATD-D4 push actor mismatch.");
        ScenarioAssert.That(notify.Payload.RequestId == requestId, "ATD-D4 push request mismatch.");
        ScenarioAssert.That(notify.Payload.Value == "bound-session-push", "ATD-D4 push value mismatch.");
