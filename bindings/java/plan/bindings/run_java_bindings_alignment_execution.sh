...
GUIDE_PATH="${SCRIPT_DIR}/java-bindings-alignment-execution-guide.ko.md"
MASTER_PLAN_PATH="${SCRIPT_DIR}/java-bindings-core-api-alignment-plan.ko.md"
SUPERVISOR_PATH="${ROOT_DIR}/core/tools/run_codex_execution_guide_loop.sh"
LOGS_DIR="${SCRIPT_DIR}/logs"
MAX_ITERATIONS=100
POLL_SECONDS=30
GATE_LABEL="java_bindings_alignment_gate"
MODEL_ARG=()
...
Run the Java bindings core-alignment execution campaign.
...
Examples:
  ./run_java_bindings_alignment_execution.sh
  ./run_java_bindings_alignment_execution.sh --max-iterations 0
  ./run_java_bindings_alignment_execution.sh --model gpt-5.4
EOF
}
...
echo "=== Java bindings alignment execution start ==="
echo "Root: ${ROOT_DIR}"
