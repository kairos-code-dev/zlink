...
{
public:
  explicit receive_gate_guard_t (channel_runtime_bundle_t &bundle)
    : _bundle (bundle)
  {
  }
...
channel_receive_loop_t::channel_receive_loop_t (
  channel_runtime_bundle_t &bundle,
...
void
channel_receive_loop_t::enqueue_server_message (
...
channel_receive_loop_t::drain_server_messages (
  ...
  const handler_registry_t &handlers)
{
  ...
  while (!_server_messages.empty ()) {
    ...
    auto reply = _pump.dispatch_server_message (
      channel_name,
      parts,
      services,
      serializers,
...
std::size_t
channel_receive_loop_t::pending_message_count () const noexcept
{
