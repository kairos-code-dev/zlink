...
> [12 HTTP client](../../framework/common/spec/12-http-client.ko.md)와
> [04 비동기 실행 정책 §1.1](../../framework/common/spec/04-async-execution-policy.ko.md)이 소유한다.
...
([framework 04 §1.1](../../framework/common/spec/04-async-execution-policy.ko.md)), callback은
awaitable을 쓰지 않는 호출자를 위한 **별도 완료 경로**다. Spot 실행 문맥에서는 `submit`과 같이
동작하며 완료 callback이 그 Spot 실행 줄의 **새 turn**으로 들어간다
([framework 12 §3](../../framework/common/spec/12-http-client.ko.md)).
...
([04 §2](../../framework/common/spec/04-async-execution-policy.ko.md)).
...
terminator는 계약 위반이다([04 §2](../../framework/common/spec/04-async-execution-policy.ko.md)).
