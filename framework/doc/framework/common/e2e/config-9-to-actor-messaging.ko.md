...
[E2E 목차](README.ko.md) | [이전: Spot yield dispatch](config-8-yield-dispatch.ko.md) | [다음: Spot actor join/transfer](config-10-spot-actor-transfer.ko.md)
...
[actor model 6.1절](../spec/actor-model.ko.md)을 기준으로 하며 여기서 다시 정의하지 않는다.
