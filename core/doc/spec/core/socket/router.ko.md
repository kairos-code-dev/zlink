[English](router.md) | 한국어

[스펙 목차](../../README.ko.md) · [코어 목차](../README.ko.md) · [소켓 공통](README.ko.md) · [errno map](../errno-map.ko.md)
...
|---|---|---|---:|
| 일반 raw multipart | 송신 peer의 routing ID | 크기가 0인 routing ID | `0` |
| 수신 request | 송신 peer의 routing ID | 크기가 0인 routing ID | 0이 아닌 reply sequence |
...
두 routing ID output은 Core가 소유한 thread-local view다. 호출자는 이를 해제하지 않으며, 다음 raw
