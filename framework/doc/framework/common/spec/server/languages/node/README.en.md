...
| No. | Document | Scope |
|---|------|------|
| `01` | [System Structure](01-system-structure.ko.md) | Package structure/deployment, NestJS module registration, DI, lifecycle including Instance Spot, and startup validation |
