---
title: "8. Session과 Actor binding · Kotlin"
---
...
다른 언어로 보기 — [C#/.NET](../../../dotnet/guide/server/08-actor-session.ko.md) · [C++](../../../cpp/guide/server/08-actor-session.ko.md) · [Java](../../../java/guide/server/08-actor-session.ko.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/server/08-actor-session.ko.md)
<!-- language-switch:end -->
