...
```java
@Component
public final class GameChatSession implements ZLinkSession {
    private final ZLinkSessionContext context;
    private final ZLinkActorManager actors;
    private ZLinkSessionActor player;

    public GameChatSession(ZLinkSessionContext context, ZLinkActorManager actors) {
