...
class support_chat_client_scenario_t
{
  public:
    ...
    bool run (connector_t &customer, connector_t &agent, connector_t &reconnecting_customer,
              connector_t &waiting_customer, connector_t &closing_customer,
...
#undef ensure
  private:
    ...
    run_async (connector_t &customer, connector_t &agent, connector_t &reconnecting_customer,
               connector_t &waiting_customer, connector_t &closing_customer,
               connector_t &closing_agent)
    {
        try {
