...
서로 다른 스레드에서 각각 copy 또는 close 작업을 수행하는 것은 안전합니다.
...
- socket request-reply 공개 표면: [socket/README.ko.md](socket.ko.md)
- SPOT routed request-reply 공개 표면: [service/spot.ko.md](spot.ko.md)
