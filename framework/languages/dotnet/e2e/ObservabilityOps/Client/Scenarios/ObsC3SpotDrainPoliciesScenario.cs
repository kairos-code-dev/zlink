...
internal static class ObsC3SpotDrainPoliciesScenario
{
    public static async Task RunAsync(ScenarioContext context)
    {
        ...
        ZlinkStreamAssert.Ensure(advanced.Version == 1, "OBS-C3 initial workflow version mismatch.");
        ...
        ZlinkStreamAssert.Ensure(workflowMetrics.Any(sample => sample.Name == "zlink.drain.rooms.drained"
                                                              && sample.Value >= 1
