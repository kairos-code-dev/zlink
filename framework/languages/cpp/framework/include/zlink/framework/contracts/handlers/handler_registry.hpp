...
public:
  ...
  {
    return add_filter ([](service_provider_t &services,
                          serializer_registry_t &,
...
private:
  ...
  static TContext make_handler_context (
  ...
  static request_context_t make_request_context (
    const handler_descriptor_t &descriptor)
  {
  ...
  handler_registry_t &add_context_void_member_handler (
    std::string channel_name,
    std::string topic,
    handler_kind_t kind,
