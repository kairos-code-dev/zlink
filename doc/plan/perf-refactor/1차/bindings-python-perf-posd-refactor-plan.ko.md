...
단계 완료. `perf_metrics.py`로 공통 유틸리티를 통합했고, single은 callback-only로 정렬되었으며, exact `MULTI_SPOT` callback smoke도 `status=complete`로 통과했다. 최신 결과 파일은 [single](/home/hep7/project/kairos/zlink/bindings/python/perf/results/single/report/perf_linux_callback_20260406_171256_blockerfix_single.txt), [multi](/home/hep7/project/kairos/zlink/bindings/python/perf/results/multi/report/perf_linux_callback_20260406_171250.txt)이다.
