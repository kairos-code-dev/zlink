package systems.zlink.samples.kotlin.supportchat.probe
...
import systems.zlink.samples.kotlin.supportchat.probe.configuration.SampleTopology
...
fun main(args: Array<String>) = runBlocking {
    ...
    error("Timed out waiting for SupportChat sample topology readiness.")
}
