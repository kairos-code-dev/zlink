---
title: "4. Backpressure — 처리보다 도착이 빠를 때 · Kotlin"
---
...
다른 언어로 보기 — [C#/.NET](../../../dotnet/guide/server/04-backpressure.ko.md) · [C++](../../../cpp/guide/server/04-backpressure.ko.md) · [Java](../../../java/guide/server/04-backpressure.ko.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/server/04-backpressure.ko.md)
<!-- language-switch:end -->
...
- socket option의 byte 단위 계약: [core guide의 socket option](https://kairos-code-dev.github.io/zlink/core/ko/guide/12-socket-options/)
