---
title: "12. Operations — Runtime Metrics · Graceful Drain · Readiness · C#/.NET"
---
...
Spots' `OnClosingAsync` with the `HostShutdown` reason, and once that callback finishes, cleans up
