...
| [registry.ko.md](core/registry.ko.md) | 서비스 레지스트리 생성, 구성, 클러스터링 |
| [discovery.ko.md](core/discovery.ko.md) | 서비스 디스커버리, 구독, 피어 조회 |
| [spot.ko.md](core/spot.ko.md) | SPOT 토픽 기반 PUB/SUB, routed 메시징 |
