...
non-null이며 Node direct 전용 context만
Node direct 전용 context만 [MeshName](../../../../01-glossary.ko.md#meshname)과 source·target RID를 추가로 제공한다. Correlation ID는 request에서 non-null이고
