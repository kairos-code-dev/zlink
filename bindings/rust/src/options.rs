    ...
    ($($ty:ty),+ $(,)?) => {
        $(
            impl CommonSocketOptionAccess for $ty {
                ...
                fn set_recv_hwm(&self, value: i32) -> Result<(), ConfigError> { self.set_recv_hwm(value) }
                fn recv_hwm(&self) -> Result<i32, ConfigError> { self.recv_hwm() }
                fn set_send_timeout(&self, d: Duration) -> Result<(), ConfigError> { self.set_send_timeout(d) }
                fn set_recv_timeout(&self, d: Duration) -> Result<(), ConfigError> { self.set_recv_timeout(d) }
                fn set_immediate(&self, enabled: bool) -> Result<(), ConfigError> { self.set_immediate(enabled) }
                fn set_connect_timeout(&self, d: Duration) -> Result<(), ConfigError> { self.set_connect_timeout(d) }
                fn set_ipv6(&self, enabled: bool) -> Result<(), ConfigError> { self.set_ipv6(enabled) }
                fn set_tcp_nodelay(&self, enabled: bool) -> Result<(), ConfigError> { self.set_tcp_nodelay(enabled) }
                fn set_tcp_keepalive(&self, enabled: bool) -> Result<(), ConfigError> { self.set_tcp_keepalive(enabled) }
                fn set_heartbeat_interval(&self, d: Duration) -> Result<(), ConfigError> { self.set_heartbeat_interval(d) }
                fn set_heartbeat_ttl(&self, d: Duration) -> Result<(), ConfigError> { self.set_heartbeat_ttl(d) }
                fn set_heartbeat_timeout(&self, d: Duration) -> Result<(), ConfigError> { self.set_heartbeat_timeout(d) }
                fn set_max_msg_size(&self, bytes: i64) -> Result<(), ConfigError> { self.set_max_msg_size(bytes) }
                fn set_backlog(&self, value: i32) -> Result<(), ConfigError> { self.set_backlog(value) }
                fn set_reconnect_interval(&self, d: Duration) -> Result<(), ConfigError> { self.set_reconnect_interval(d) }
                fn set_reconnect_interval_max(&self, d: Duration) -> Result<(), ConfigError> { self.set_reconnect_interval_max(d) }
            }
        )+
    };
}
...
impl<'a> RouterSocketOptions<'a> {
    ...
    pub fn set_handover(&self, enabled: bool) -> Result<(), ConfigError> {
