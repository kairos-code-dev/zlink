...
public final class GameSession implements ZLinkSession {
    ...
    public GameSession(ZLinkSessionContext context, ZLinkActorManager actors) {
...
- 실행 코드: [Java GameQuest 샘플](../../../../../languages/java/samples/java/GameQuest)
...
- 실행 예제: [tictactoe 샘플](../samples/tictactoe-game-sample.ko.md), [bingo 샘플](../samples/bingo-game-sample.ko.md), [GameQuest 샘플](../../../../../languages/java/samples/java/GameQuest)
