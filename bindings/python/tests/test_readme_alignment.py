...
class ReadmeAlignmentTests(unittest.TestCase):
    def test_python_readme_exists_and_references_binding_policy(self):
        ...
        self.assertIn("send_to_channel", readme)
        self.assertIn("request_to_channel", readme)
        self.assertIn("attach_channel_dealer", readme)
        self.assertIn("attach_channel_dealer_manual", readme)
        self.assertIn("attach_pub_ingress", readme)
