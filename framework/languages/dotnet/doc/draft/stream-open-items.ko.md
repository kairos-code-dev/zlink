...
[문서 목록](../../../../doc/README.ko.md) | [이전: ZLink Framework .NET Backend Dependency Policy](../internals/backend-dependency-policy.ko.md)
...
**확정 -- 본문은 [handler-interfaces.ko.md](../spec/handler-interfaces.ko.md) §4.4 와
[aspnet-core-stream.ko.md](../spec/aspnet-core-stream.ko.md) §3 을 본다.**
