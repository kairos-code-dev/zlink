...
| Messaging | 미착수 | `Contracts/Messaging/`: `message.hpp`, `received.hpp`, `topic_message.hpp`, `subscription_event.hpp`, `operation_contracts.hpp`, `request_result.hpp`(`lazy_message_parts.hpp`와 `operation_builder_base.hpp`는 `detail`이라 public 항목 없음) |
| Sockets | 미착수 | `Contracts/Sockets/`: `socket_contracts.hpp`, `message_socket_contracts.hpp`, `routed_socket_contracts.hpp`, `pubsub_socket_contracts.hpp`, `stream_socket.hpp`, `socket_options.hpp`, `results.hpp` |
| Eventing | 미착수 | `Contracts/Eventing/`: `monitor.hpp`, `status.hpp`, `poller.hpp`, `poll_event.hpp`, `timers.hpp`, `events.hpp` |
