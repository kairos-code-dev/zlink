package systems.zlink.samples.supportchat.probe;
...
import systems.zlink.samples.supportchat.probe.configuration.SampleTopology;
...
public final class Program {
    ...
    public static void main(String[] args) {
        ...
        List<String> endpoints = List.of(
            ...
            SampleTopology.SupportChannelEndpoint,
            SampleTopology.SessionSpotEndpoint,
            SampleTopology.SessionRouterEndpoint,
            SampleTopology.SupportSpotEndpoint,
        ...
        throw new IllegalStateException("Timed out waiting for SupportChat sample topology readiness.");
    }
