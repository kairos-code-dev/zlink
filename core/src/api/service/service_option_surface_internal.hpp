...
int zlink_service_spot_set_common_option_internal (void *handle_,
                                                   ...
                                                   const void *optval_,
                                                   size_t optvallen_);
int zlink_service_spot_get_common_option_internal (
  void *handle_, zlink_option_t option_, int socket_option_, void *optval_, size_t *optvallen_);
...
int zlink_service_spot_set_pub_option_internal (void *handle_,
                                                ...
                                                const void *optval_,
                                                size_t optvallen_);
int zlink_service_spot_get_pub_option_internal (
  void *handle_, zlink_pub_option_t option_, int socket_option_, void *optval_, size_t *optvallen_);
int zlink_service_spot_set_sub_option_internal (void *handle_,
                                                ...
                                                const void *optval_,
                                                size_t optvallen_);
int zlink_service_spot_get_sub_option_internal (
  void *handle_, zlink_sub_option_t option_, int socket_option_, void *optval_, size_t *optvallen_);
int zlink_service_spot_set_subscription_internal (void *handle_, const char *filter_);
int zlink_service_spot_unset_subscription_internal (void *handle_, const char *filter_);
int zlink_service_spot_subscription_at_internal (
  void *handle_, size_t index_, char *filter_out_, size_t *filter_len_inout_, int *is_pattern_out_);
