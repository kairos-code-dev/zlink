...
int main (int argc, char **argv)
{
    ...
    app.add_zlink_framework ([&] (zlink_framework_options_t &options) {
        ...
        auto sessions = std::make_shared<customer_session_directory_t> ();
        options.services ().add_factory<customer_session_directory_t> (
          [sessions] (service_provider_t &) { return sessions; }, service_lifetime_t::singleton);
