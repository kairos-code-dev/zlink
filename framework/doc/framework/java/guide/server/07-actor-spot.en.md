...
View in another language — [C#/.NET](../../../dotnet/guide/server/07-actor-spot.en.md) · [C++](../../../cpp/guide/server/07-actor-spot.en.md) · **Java** · [Kotlin](../../../kotlin/guide/server/07-actor-spot.en.md) · [Node/TypeScript](../../../node/guide/server/07-actor-spot.en.md)
<!-- language-switch:end -->
