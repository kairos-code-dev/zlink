...
[스펙 목차](../README.ko.md) | [이전: STREAM 서버 세션](30-stream-session.ko.md) | [다음: Stream Connector](../stream-connector/32-stream-connector.ko.md)
<!-- framework-adapter-nav:end -->


[문서 묶음](../../common/README.ko.md) | [Actor 모델](22-actor-model.ko.md) | [framework API](../05-framework-api.ko.md) | [.NET Session Actor Dispatch](languages/dotnet/02-handler-interfaces.ko.md)
...
([샘플 규약](../../common/sample/README.ko.md)).
...
그대로 담는다**([Stream Connector §4](../stream-connector/32-stream-connector.ko.md)). 위 multipart 계약은
...
hex 문자열을 client 계약에 그대로 노출하지 않는다([샘플 규약](../../common/sample/README.ko.md)). actor가
