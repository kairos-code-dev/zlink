...
object SampleNames {
    const val Mesh: String = "bingo.play"
    const val MatchmakingMesh: String = "bingo.matchmaking"
    const val ApiChannel: String = "bingo.api"
    const val ApiAllocationGroup: String = "bingo.api"
    const val PlayAllocationGroup: String = "bingo.play"
