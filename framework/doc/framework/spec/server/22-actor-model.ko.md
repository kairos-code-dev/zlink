...
[문서 묶음](../../common/README.ko.md) | [개요](../01-overview.ko.md) | [상호작용 모델](../02-interaction-model.ko.md) | [메시지 모델](../03-message-model.ko.md) | [channel topology](10-channel-topology.ko.md) | [framework API](../05-framework-api.ko.md) | [Session Actor Dispatch 사용성](31-session-actor-dispatch.ko.md)
...
구체적인 bind 상태별 검증은 [Config 9](../../common/e2e/config-9-to-actor-messaging.ko.md)에 둔다.
