...
channel_bundle_factory_t::create_client_bundle (
...
std::shared_ptr<channel_runtime_bundle_t>
channel_bundle_factory_t::create_server_bundle (
  const std::string &channel_name,
  const channel_snapshot_t &channel) const
{
...
std::shared_ptr<channel_runtime_bundle_t>
channel_bundle_factory_t::create_publisher_bundle (
  const std::string &channel_name,
  const channel_snapshot_t &channel) const
{
...
std::shared_ptr<channel_runtime_bundle_t>
channel_bundle_factory_t::create_subscriber_bundle (
  const std::string &channel_name,
  const channel_snapshot_t &channel) const
{
...
std::shared_ptr<channel_runtime_bundle_t>
channel_bundle_factory_t::create_bundle (
  const std::string &channel_name,
