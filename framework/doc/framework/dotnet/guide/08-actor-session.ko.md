...
> 정식 계약은 [spec/aspnet-core-actor](../../common/spec/languages/dotnet/02-handler-interfaces.ko.md)와
> [spec/session-actor-dispatch](../../common/spec/languages/dotnet/02-handler-interfaces.ko.md)가 다룬다.
...
> SpotNode/StreamNode 등록 시그니처는 [spec/aspnet-core-actor](../../common/spec/languages/dotnet/02-handler-interfaces.ko.md)와 샘플 코드를
> 기준으로 확인한다.
...
- 정식 계약: [spec/aspnet-core-actor](../../common/spec/languages/dotnet/02-handler-interfaces.ko.md), [spec/session-actor-dispatch](../../common/spec/languages/dotnet/02-handler-interfaces.ko.md)
