...
if SELECTOR in ("all", "OBS-A1"):
    ...
    play = [
        line for line in lines("play-a-before-c1-flow.log") + lines("play-a-flow.log")
...
if SELECTOR in ("all", "OBS-A4"):
    # The full runner restarts play-a for the lifecycle scenarios after A4.
    # Preserve the pre-restart flow rows so A4 evidence is not lost when the
    # current process opens play-a-flow.log again.
    play_a = lines("play-a-before-c1-flow.log") + lines("play-a-flow.log")
