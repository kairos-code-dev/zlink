...
export BINGO_SESSION_SPOT_ENDPOINT="${BINGO_SESSION_SPOT_ENDPOINT:-tcp://127.0.0.1:$((BASE_PORT + 5))}"
export BINGO_SESSION_ROUTER_ENDPOINT="${BINGO_SESSION_ROUTER_ENDPOINT:-tcp://127.0.0.1:$((BASE_PORT + 6))}"
export BINGO_RECONNECT_SESSION_SPOT_ENDPOINT="${BINGO_RECONNECT_SESSION_SPOT_ENDPOINT:-tcp://127.0.0.1:$((BASE_PORT + 7))}"
export BINGO_RECONNECT_SESSION_ROUTER_ENDPOINT="${BINGO_RECONNECT_SESSION_ROUTER_ENDPOINT:-tcp://127.0.0.1:$((BASE_PORT + 8))}"
export BINGO_PLAY_ROUTER_ENDPOINT="${BINGO_PLAY_ROUTER_ENDPOINT:-tcp://127.0.0.1:$((BASE_PORT + 9))}"
export BINGO_PLAY_SPOT_ENDPOINT="${BINGO_PLAY_SPOT_ENDPOINT:-tcp://127.0.0.1:$((BASE_PORT + 10))}"
export BINGO_PLAY_SPOT_ROUTER_ENDPOINT="${BINGO_PLAY_SPOT_ROUTER_ENDPOINT:-tcp://127.0.0.1:$((BASE_PORT + 11))}"
export BINGO_STREAM_ENDPOINT="${BINGO_STREAM_ENDPOINT:-tcp://127.0.0.1:$((BASE_PORT + 12))}"
export BINGO_RECONNECT_STREAM_ENDPOINT="${BINGO_RECONNECT_STREAM_ENDPOINT:-tcp://127.0.0.1:$((BASE_PORT + 13))}"
