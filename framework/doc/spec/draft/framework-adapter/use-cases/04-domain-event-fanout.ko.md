...
[문서 목록](../README.ko.md) | [이전: Draft Use Case -- Worker Dispatch](03-worker-dispatch.ko.md) | [다음: Draft Use Case -- Cache Invalidation And Config Refresh](05-cache-invalidation-and-config-refresh.ko.md)
