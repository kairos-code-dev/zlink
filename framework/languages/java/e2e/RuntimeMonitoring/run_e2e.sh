...
pids=()
role_pattern='systems\.zlink\.e2e\.runtimemonitoring\.(client|registry|service|trigger)\.Program'
...
ZLINK_JAVA_E2E_LOG_DIR="${log_dir}" \
  "$(trigger_bin)" >"${log_dir}/validation.stdout.log" 2>"${log_dir}/validation.stderr.log"
