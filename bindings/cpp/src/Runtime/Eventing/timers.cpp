...
timer_t::timer_t () : _impl (new impl)
{
...
bool timer_t::valid () const noexcept { return _impl && _impl->handle != NULL; }
...
void timer_t::set_handler (std::function<void(uint64_t)> handler_)
{
