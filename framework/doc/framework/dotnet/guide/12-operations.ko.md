...
> `.NET` 표면의 정식 정의는 [spec/aspnet-core-monitoring §10·§12](../../common/spec/languages/dotnet/01-system-structure.ko.md)다.
...
[공통 스펙 §4](../../common/spec/51-runtime-metrics.ko.md)를 본다.
