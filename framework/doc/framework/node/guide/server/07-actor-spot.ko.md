---
title: "7. Actor와 Spot · Node/TypeScript"
---
...
다른 언어로 보기 — [C#/.NET](../../../dotnet/guide/server/07-actor-spot.ko.md) · [C++](../../../cpp/guide/server/07-actor-spot.ko.md) · [Java](../../../java/guide/server/07-actor-spot.ko.md) · [Kotlin](../../../kotlin/guide/server/07-actor-spot.ko.md) · **Node/TypeScript**
<!-- language-switch:end -->
