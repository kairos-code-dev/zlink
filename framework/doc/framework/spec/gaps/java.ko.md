...
- [ ] **E2E-JV-05** (결함) — 4개 runner 해결. 나머지는 readiness가 최대 **20배**(60초)이고 route settle이 **7개 runner에 없다**
