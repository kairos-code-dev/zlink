...
| 6 | [6. Spot](../../../common/guide/server/06-spot.ko.md) | room · stage · zone 같은 동적 상태 단위 |
| 7 | [7. Actor와 Spot](../../../common/guide/server/07-actor-spot.ko.md) | actor 호스팅, membership, relocation |
...
01 · 02 · 11 · 13 · 16장은 설치 방법과 표면 이름이 언어마다 달라 Node.js 전용으로
따로 쓴다. 아직 작성하지 않았다.
