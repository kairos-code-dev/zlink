...
| 바인딩 | API Spec |
|--------|----------|
| Node.js | [`NODE_API_SPEC.md`](https://github.com/kairos-code-dev/zlink/blob/main/doc/spec/bindings/node/README.md) |
| Python | [`PYTHON_API_SPEC.md`](https://github.com/kairos-code-dev/zlink/blob/main/doc/spec/bindings/python/README.md) |
