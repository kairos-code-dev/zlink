...
| 12 | [41-location-store-redis.ko.md](../spec/server/41-location-store-redis.ko.md) | 공식 Redis location store extension의 key, lease, 원자 write, 오류와 테스트 계약을 정의한다. |
| 13 | [24-spot-address-messaging.ko.md](../spec/server/24-spot-address-messaging.ko.md) | spot/actor 대상 주소, 조회와 재조회, 실패 분류와 이동 경계를 정의한다. |
