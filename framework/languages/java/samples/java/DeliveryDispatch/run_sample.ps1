...
$RolePattern = "systems\.zlink\.samples\.deliverydispatch\.(server\.(registry|dispatchapi|dispatchcenter|courier|tracking|session)\.Program|client\.Program|probe\.Program)"
...
try {
    ...
    Push-Location "../../.."
    try {
        & ./gradlew --no-daemon :zlink-framework-core:jar :zlink-framework-spring-boot-starter:jar :zlink-stream-connector:jar :zlink-stream-connector-json:jar --quiet
