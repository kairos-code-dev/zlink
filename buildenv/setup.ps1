...
#
# Usage:
#   .\buildenv\setup.ps1                        # Detect only (no changes)
#   .\buildenv\setup.ps1 -Install               # Install missing tools
#   .\buildenv\setup.ps1 -Install -BuildCore    # Install + build core library
#   .\buildenv\setup.ps1 -Bindings java,node    # Check specific bindings only
#   . .\buildenv\env.ps1                        # Activate dev environment
# =============================================================================
...
Write-Host "     . .\buildenv\env.ps1" -ForegroundColor White
Write-Host ""
if (-not $coreBuildResult.Found) {
    Write-Host "  2. Build core library:" -ForegroundColor DarkGray
    Write-Host "     .\buildenv\setup.ps1 -BuildCore" -ForegroundColor White
