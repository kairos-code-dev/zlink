...
class bingo_entry_spot_t : public zlink::framework::entry_spot_t
{
  public:
    ...
    void onCreateActor (player_actor_t &actor, const zlink::framework::message_t &create_request)
    {
  ...
  private:
    static zlink::framework::spot_rid_t observer_room_rid (const std::string &room_id,
                                                           zlink::framework::node_rid_t node_rid)
    {
        return zlink::framework::spot_rid_t::from_string ("observe:" + room_id + ":"
