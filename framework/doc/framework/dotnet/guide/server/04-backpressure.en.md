---
title: "4. Backpressure — When Arrival Outpaces Processing · C#/.NET"
---
...
View in another language — **C#/.NET** · [C++](../../../cpp/guide/server/04-backpressure.en.md) · [Java](../../../java/guide/server/04-backpressure.en.md) · [Kotlin](../../../kotlin/guide/server/04-backpressure.en.md) · [Node/TypeScript](../../../node/guide/server/04-backpressure.en.md)
<!-- language-switch:end -->
