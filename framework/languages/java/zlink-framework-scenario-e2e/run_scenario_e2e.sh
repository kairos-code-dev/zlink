...
APP_BIN="$ROOT_DIR/build/install/zlink-framework-scenario-e2e/bin/zlink-framework-scenario-e2e"
...
(cd "$JAVA_ROOT" && ./gradlew :zlink-framework-scenario-e2e:installDist >/dev/null)
