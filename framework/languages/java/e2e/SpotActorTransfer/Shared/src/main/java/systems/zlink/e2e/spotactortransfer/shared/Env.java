...
public final class Env {
    ...
    public static void configure(String[] args) {
        ...
        try (Reader reader = Files.newBufferedReader(Path.of(args[1]))) {
            ...
            throw new IllegalStateException("Could not load SpotActorTransfer config.", error);
        }
        values = loaded;
    }
    ...
    public static String require(String name) {
        ...
        if (value == null || value.isBlank()) {
            throw new IllegalStateException("configuration value is required: " + name);
        }
        return value;
    }
    ...
    private static Properties properties() {
        if (values == null) {
            throw new IllegalStateException("SpotActorTransfer configuration was not loaded.");
        }
        return values;
    }
}
