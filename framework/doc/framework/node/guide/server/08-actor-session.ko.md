---
title: "8. Session과 Actor binding · Node/TypeScript"
---
...
다른 언어로 보기 — [C#/.NET](../../../dotnet/guide/server/08-actor-session.ko.md) · [C++](../../../cpp/guide/server/08-actor-session.ko.md) · [Java](../../../java/guide/server/08-actor-session.ko.md) · [Kotlin](../../../kotlin/guide/server/08-actor-session.ko.md) · **Node/TypeScript**
<!-- language-switch:end -->
