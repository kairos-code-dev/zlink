...
[.NET 묶음](../README.ko.md) | [인터페이스](handler-interfaces.ko.md) | [Actor](aspnet-core-actor.ko.md) | [STREAM](aspnet-core-stream.ko.md) | [policy/Session Actor Dispatch 사용성](../../common/spec/session-actor-dispatch.ko.md)
...
- send 성격의 `RelayAsync(...)` 는 actor 의 실행 줄에 packet 을 넣는
  데 성공한 시점에 끝난다.
