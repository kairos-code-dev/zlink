...
- 정식 계약: [spring-boot-monitoring §7](../../common/spec/languages/java/spring-boot-monitoring.ko.md), 공통 의미:
...
- 정식 계약: [spring-boot-monitoring](../../common/spec/languages/java/spring-boot-monitoring.ko.md)
