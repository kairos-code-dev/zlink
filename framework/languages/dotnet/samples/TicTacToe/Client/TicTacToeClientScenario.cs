...
public sealed class TicTacToeClientScenario
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var client1Authentication = await client1.Request(new AuthenticateReq(options.XActorId)).SubmitAsync<AuthenticateRes>(cancellationToken);
        Ensure(client1Authentication.ActorId == options.XActorId);

        var client1Join = await client1.Request(new JoinGameReq(room.RoomId)).SubmitAsync<JoinGameRes>(cancellationToken);
        ...
        var client2Authentication = await client2.Request(new AuthenticateReq(options.OActorId)).SubmitAsync<AuthenticateRes>(cancellationToken);
        Ensure(client2Authentication.ActorId == options.OActorId);
        Ensure(client2Authentication.ActorId != client1Authentication.ActorId);

        var client2Join = await client2.Request(new JoinGameReq(room.RoomId)).SubmitAsync<JoinGameRes>(cancellationToken);
        ...
        var client1Move1 = await client1.Request(new PlaceMarkReq(0)).SubmitAsync<PlaceMarkRes>(cancellationToken);
        ...
        var client2Move1 = await client2.Request(new PlaceMarkReq(3)).SubmitAsync<PlaceMarkRes>(cancellationToken);
        ...
        var client1Move2 = await client1.Request(new PlaceMarkReq(1)).SubmitAsync<PlaceMarkRes>(cancellationToken);
        ...
        var client2Move2 = await client2.Request(new PlaceMarkReq(4)).SubmitAsync<PlaceMarkRes>(cancellationToken);
        ...
        var client1FinalMove = await client1.Request(new PlaceMarkReq(2)).SubmitAsync<PlaceMarkRes>(cancellationToken);
