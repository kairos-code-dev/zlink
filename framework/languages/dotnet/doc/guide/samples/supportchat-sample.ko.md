...
[문서 목록](../../../../../doc/README.ko.md) | [이전: Bingo Game Sample](./bingo-game-sample.ko.md) | [다음: DeliveryDispatch Sample](./deliverydispatch-sample.ko.md)
...
> 먼저 보고, 이 문서에서는 DTO, 서버 구조, 실행 흐름을 확인한다. 언어 중립 공통
