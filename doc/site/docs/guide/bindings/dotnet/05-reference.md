[← 운영](./04-operations.md) · [.NET 가이드](./index.md)
...
자세한 내용: [바인딩 코덱 정책](https://github.com/kairos-code-dev/zlink/blob/main/doc/spec/bindings/dotnet/codec.md).
...
- [소켓 패턴](../../03-0-socket-patterns.md) · [트랜스포트](../../04-transports.md) ·
  [서비스](../../07-0-services.md)
- [메시지 API](../../09-message-api.md) · [소켓 옵션](../../12-socket-options.md) ·
  [성능](../../10-performance.md)
