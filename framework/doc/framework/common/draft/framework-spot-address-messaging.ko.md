...
- [x] E2E: config-2 spot service 갱신(전 시나리오 그린) + YD shutdown-recovery 해소. DD courier 결정 릴레이는 native actor gateway 전달 조사로 분리 진행 (§10.4)
- [x] 문서: §9 수정 목록 반영 (location resolver/store 초안 갱신)
