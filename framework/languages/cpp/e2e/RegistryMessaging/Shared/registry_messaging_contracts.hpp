...
struct request_failure_result_t
{
    bool failed = false;
...
struct backpressure_send_result_t
{
    std::string outcome;
};
...
inline void to_json (nlohmann::json &json, const request_failure_result_t &value)
{
    json = nlohmann::json{{"failed", value.failed}, {"error_type", value.error_type}};
}

inline void from_json (const nlohmann::json &json, request_failure_result_t &value)
{
...
inline void to_json (nlohmann::json &json, const backpressure_send_result_t &value)
{
    json = nlohmann::json{{"outcome", value.outcome}};
}

inline void from_json (const nlohmann::json &json, backpressure_send_result_t &value)
{
