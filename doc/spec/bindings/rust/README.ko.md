...
- `core/`: context, context option, routing id, version/capability 헬퍼, 유틸리티
  계약.
...
- Core: context, option, version/capability 헬퍼, 유틸리티.
...
- Context lifecycle, option, shutdown, auto-HWM 재계산, version, capability,
  strerror.
