...
[문서 목록](../../../../../doc/README.ko.md) | [이전: DeliveryDispatch Sample](./deliverydispatch-sample.ko.md) | [다음: GameQuest Sample](./gamequest-sample.ko.md)
<!-- framework-adapter-nav:end -->

# ShoppingMallCheckout Sample
...
> [spec/sample/event/shoppingmall-checkout](../../../../../doc/spec/sample/event/shoppingmall-checkout.ko.md)이 소유한다.

## 1. 목적

ShoppingMallCheckout 은 외부 HTTP API 와 stateful workflow owner 를 분리해도 주문 상태
