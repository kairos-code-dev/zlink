...
| `.NET: Server/Play/Infrastructure/ZLink/Spots/TicTacToeGameSpot/Handlers/PlayActorLeaveGameHandler.cs` | `Server/Play/Infrastructure/ZLink/Spots/TicTacToeGameSpot/tictactoe_game_spot.hpp` | spot-handler | done | `LeaveGameReq`는 reply 없는 actor send command로 등록하고 Entry Spot 복귀 흐름을 실행한다. |
