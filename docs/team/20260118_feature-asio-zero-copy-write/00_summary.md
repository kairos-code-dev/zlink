...
## pending buffer offset 적용 (erase 제거)
- 변경: pending buffer를 offset으로 관리해 erase/재할당 제거.
- 로그: `docs/team/20260118_feature-asio-zero-copy-write/21_pair_tcp_1k_64k_runs10_pending_offset.txt`
- PAIR, TCP (1K/64K):
  - 1K throughput +27.80% (latency -5.08%)
  - 64K throughput +49.65% (latency -23.63%)

## 전체 패턴 재측정 (TCP, pending offset)
- 로그: `docs/team/20260118_feature-asio-zero-copy-write/22_all_patterns_tcp_1k_64k_runs10_pending_offset.txt`
- PAIR: 1K +35.62%, 64K +53.48% (lat -21.20%)
- PUBSUB: 1K +37.08%, 64K +39.34% (lat +29.27%)
- DEALER_DEALER: 1K +32.79%, 64K +35.55% (lat -23.40%)
- DEALER_ROUTER: 1K +31.84%, 64K +45.57% (lat -20.72%)
- ROUTER_ROUTER: 1K +30.47%, 64K +36.05% (lat -53.64%)
- ROUTER_ROUTER_POLL: 1K +29.57%, 64K +18.02% (lat -38.95%)

## 전체 패턴 재측정 (TCP/IPC/INPROC, pending offset)
- 로그: `docs/team/20260118_feature-asio-zero-copy-write/23_all_patterns_all_transports_1k_64k_runs10_pending_offset.txt`
- PAIR:
  - TCP: 1K +32.20%, 64K +45.85%
  - INPROC: 1K +132.88%, 64K +24.35%
  - IPC: 1K +29.01%, 64K +51.55%
- PUBSUB:
  - TCP: 1K +42.36%, 64K +58.33%
  - INPROC: 1K +118.00%, 64K -20.67%
  - IPC: 1K +34.12%, 64K +43.43%
- DEALER_DEALER:
  - TCP: 1K +35.27%, 64K +18.90%
  - INPROC: 1K +134.17%, 64K +50.68%
  - IPC: 1K +44.24%, 64K +30.56%
- DEALER_ROUTER:
  - TCP: 1K +26.49%, 64K +26.03%
  - INPROC: 1K +101.20%, 64K -20.87%
  - IPC: 1K +28.28%, 64K +32.74%
- ROUTER_ROUTER:
  - TCP: 1K +38.77%, 64K +32.65%
  - INPROC: 1K +98.95%, 64K +0.59%
  - IPC: 1K +24.89%, 64K +18.56%
- ROUTER_ROUTER_POLL:
  - TCP: 1K +25.67%, 64K +26.17%
  - INPROC: 1K +68.00%, 64K -13.35%
  - IPC: 1K +22.93%, 64K +21.35%
