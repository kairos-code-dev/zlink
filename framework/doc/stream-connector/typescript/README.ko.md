...
| [TypeScript 공개 계약](../../framework/common/spec/stream-connector/languages/typescript/03-stream-connector.ko.md) | 정확한 public 타입과 package root |
| [Stream Connector 공통 스펙](../../framework/common/spec/stream-connector/32-stream-connector.ko.md) | 대상 환경, transport와 wire 계약 |
