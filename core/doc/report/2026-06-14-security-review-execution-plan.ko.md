...
| 4 | [2026-06-13-core-src-security-review.ko.md](2026-06-13-core-src-security-review.ko.md) | 진행 중 | 2026-06-14: #1 mtrie 비재귀화 수정·core/C++ binding 검증 통과·Claude 추가 이슈 없음, C binding은 기존 C-BINDING-001 버전 테스트 불일치로 실패 |
