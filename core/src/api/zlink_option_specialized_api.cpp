...
bool zlink_set_router_option (void *handle_,
...
bool zlink_get_router_option (void *handle_,
                              zlink_router_option_t option_,
                              void *optval_,
                              size_t *optvallen_)
{
...
bool zlink_set_dealer_option (void *handle_,
...
bool zlink_get_stream_option (void *handle_,
                              zlink_stream_option_t option_,
                              void *optval_,
                              size_t *optvallen_)
{
    ...
    if (!socket)
        return false;
    return zlink::status_internal::from_rc (get_socket_option_checked (
      socket, socket_type_of (socket), ZLINK_CORE_SOCKET_STREAM,
      ZLINK_CORE_SOCKET_STREAM, socket_option, optval_, optvallen_));
}

bool zlink_set_spot_option (void *handle_,
...
bool zlink_get_spot_option (void *handle_,
                            zlink_spot_option_t option_,
                            void *optval_,
                            size_t *optvallen_)
{
...
bool zlink_set_pub_option (void *handle_,
...
bool zlink_get_pub_option (void *handle_,
                           zlink_pub_option_t option_,
                           void *optval_,
                           size_t *optvallen_)
{
...
bool zlink_set_sub_option (void *handle_,
...
bool zlink_get_sub_option (void *handle_,
                           zlink_sub_option_t option_,
                           void *optval_,
                           size_t *optvallen_)
{
...
bool zlink_set_spot_node_option (void *handle_,
...
bool zlink_get_spot_node_option (void *handle_,
                                 zlink_spot_node_option_t option_,
                                 void *optval_,
                                 size_t *optvallen_)
{
