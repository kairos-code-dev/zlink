...
남은 차이는 파일 분류 수준이다. `.NET`은 CustomerGateway/CourierActorNode의 actor, directory, entry spot,
handler를 여러 C# 파일로 나누지만 C++ E2E는 아직 일부 책임을 role `main.cpp` 안에 둔다. public 동작과
