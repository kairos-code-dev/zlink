...
public record ServiceOptions(
    ...
    String spotEndpoint, String spotPubEndpoint, String httpEndpoint,
    ...
    public ServiceOptions {
        ...
        handshakeEndpoint = optional(handshakeEndpoint); spotEndpoint = optional(spotEndpoint); spotPubEndpoint = optional(spotPubEndpoint);
        if (enableHandshake) required(handshakeEndpoint, "handshake-endpoint");
        if (enableSpot) { required(spotEndpoint, "spot-endpoint"); required(spotPubEndpoint, "spot-pub-endpoint"); }
    }
