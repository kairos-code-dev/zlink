...
class ConsoleDisplay
{
  public:
    ...
    static void print_send (const std::string &client_name,
                            const std::string &server_label,
                            const std::string &message);
    static void print_recv (const std::string &client_name,
                            const std::string &server_label,
                            const std::string &message,
                            const std::string &annotation = "");
    static void print_no_event (const std::string &client_name,
                                const std::string &server_label,
