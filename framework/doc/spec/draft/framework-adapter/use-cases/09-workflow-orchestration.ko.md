...
[문서 목록](../README.ko.md) | [이전: Draft Use Case -- Scatter Gather Query](08-scatter-gather-query.ko.md) | [다음: ZLink Framework Use Case Validation](../usecase-validation.ko.md)
...
# Draft Use Case -- Workflow Orchestration

> 이 문서는 **구현 전 초안**이다.
> 현재 공개 계약이 아니며, 여러 서비스 단계를 거치는 workflow use case를
> 정리하기 위한 초안이다.
...
이 use case는 중요한 운영 시나리오지만, 현재 초안에서는 아직 공통 metadata
