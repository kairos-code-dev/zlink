...
- Multi 상태: `MULTI_DEALER_DEALER, MULTI_DEALER_ROUTER 완료, 나머지 pattern 미측정`
- 다음 작업: Multi `MULTI_DEALER_ROUTER_REQREP`의 tcp transport를 C와 C++ 순서로 CPU pin 없이 paired 측정한다.
