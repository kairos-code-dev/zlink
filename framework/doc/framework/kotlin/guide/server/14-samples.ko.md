---
title: "14. 샘플 고르기 — 내 문제에 가까운 예제부터 · Kotlin"
---
...
[가이드 홈](README.ko.md) | [이전: 13. 주요 interface 사용 색인 — Kotlin이 더하는 것](13-interface-catalog.ko.md) | [다음: 15. E2E 테스트 — client로 시스템 전체를 검증하기](15-e2e-testing.ko.md)
<!-- framework-adapter-nav:end -->

<!-- language-switch:start -->
다른 언어로 보기 — [C#/.NET](../../../dotnet/guide/server/14-samples.ko.md) · [C++](../../../cpp/guide/server/14-samples.ko.md) · [Java](../../../java/guide/server/14-samples.ko.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/server/14-samples.ko.md)
<!-- language-switch:end -->
