...
**작성일**: 2026-02-03
**수정 파일**: `core/bench/benchwithzlink/current/bench_current_gateway.cpp`
...
**파일**: `core/bench/benchwithzlink/current/bench_current_gateway.cpp`
...
| 파일 | 설명 |
|------|------|
| `core/bench/benchwithzlink/current/bench_current_gateway.cpp` | 수정된 벤치마크 |
