...
| [.NET 공개 계약](../../spec/stream-connector/languages/dotnet/03-stream-connector.ko.md) | public 타입과 시그니처 |
| [Stream Connector 공통 스펙](../../spec/stream-connector/32-stream-connector.ko.md) | **정본** — 대상 환경, transport, wire 계약 |
