...
> 언어 중립 정식 정의는 [공통 스펙 목차](../../../../doc/spec/README.ko.md)가,
> C++ 표면의 자세한 계약은 [spec/](../spec/cpp-framework-interfaces.ko.md) 문서가
...
이 가이드가 설명하는 표면은 [spec/](../spec/cpp-framework-interfaces.ko.md) 의 계약을
