...
| `Client/Support/ScenarioAssert.cs` | `Client/src/main/java/systems/zlink/e2e/yielddispatch/client/Support/YieldDispatchScenarioSupport.java` | support | done | evidence 조회, marker order assertion, stream connector helper를 공유한다. |
