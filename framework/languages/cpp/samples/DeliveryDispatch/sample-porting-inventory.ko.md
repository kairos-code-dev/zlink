...
| `Server/CustomerGateway/Spots/EntrySpot/CustomerEntrySpot.cs` | `Server/CustomerGateway/main.cpp` | spot | done | CustomerGateway entry spot이 actor 조회, 구독, 상태 갱신 handler를 등록한다. |
