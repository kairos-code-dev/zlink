...
> 정식 계약은 [spec/aspnet-core-monitoring](../../common/spec/languages/dotnet/01-system-structure.ko.md)가
> 다룬다.
...
- **handler payload의 정확한 필드** → 가이드는 자주 쓰는 필드만 보였다. 전체는
  [spec/aspnet-core-monitoring](../../common/spec/languages/dotnet/01-system-structure.ko.md) 참고.
...
- 정식 계약은 [spec/aspnet-core-monitoring §9](../../common/spec/languages/dotnet/01-system-structure.ko.md), 공통 의미는
...
- 정식 계약: [spec/aspnet-core-monitoring](../../common/spec/languages/dotnet/01-system-structure.ko.md)
