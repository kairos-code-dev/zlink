...
void discovery_t::set_tls_client (
...
void discovery_t::set_value (int64_t value_)
{
    detail::throw_if_failed<config_error_t> (
      static_cast<config_result_t> (
        zlink_discovery_set_value (_impl->handle, value_)));
}
...
void discovery_t::get_value (int64_t *value_out_) const
{
    detail::throw_if_failed<config_error_t> (
      static_cast<config_result_t> (
        zlink_discovery_get_value (_impl->handle, value_out_)));
}
...
void discovery_t::set_spot_owner_sync_enabled (bool enabled_)
{
    ...
    detail::throw_if_failed<config_error_t> (
      static_cast<config_result_t> (
        zlink_set_option (
          _impl->handle, static_cast<zlink_option_t> (12341), &value,
          sizeof (value))));
}
...
bool discovery_t::spot_owner_sync_enabled () const
{
    ...
    detail::throw_if_failed<config_error_t> (
      static_cast<config_result_t> (
        zlink_get_option (
          _impl->handle, static_cast<zlink_option_t> (12341), &value, &size)));
    return value != 0;
}
...
void discovery_t::set_actor_route_sync_enabled (bool enabled_)
{
    ...
    detail::throw_if_failed<config_error_t> (
      static_cast<config_result_t> (
        zlink_set_option (
          _impl->handle, static_cast<zlink_option_t> (12342), &value,
          sizeof (value))));
}
...
bool discovery_t::actor_route_sync_enabled () const
{
    ...
    detail::throw_if_failed<config_error_t> (
      static_cast<config_result_t> (
        zlink_get_option (
          _impl->handle, static_cast<zlink_option_t> (12342), &value, &size)));
    return value != 0;
}
        ...
        detail::throw_if_failed<config_error_t> (
          static_cast<config_result_t> (
            zlink_discovery_member_peers (
              _impl->handle, native.data (), &count)));
        native.resize (count);
    }
