...
sourceSets {
    main {
        kotlin {
            ...
            srcDir("src/main/kotlin")
            include("systems/zlink/samples/kotlin/tictactoe/sessiongateway/server/session/**")
            include("systems/zlink/samples/kotlin/tictactoe/sessiongateway/server/play/**")
...
application {
    mainClass.set("systems.zlink.samples.kotlin.tictactoe.sessiongateway.server.session.ProgramKt")
