...
class tictactoe_player_client_t
{
  public:
                                              ...
                                              const tictactoe_client_options_t &options)
    {
        ...
        client._connected = zlink::samples::connect_client_connector (client._connector);
        return client;
    }

    bool connected () const noexcept { return _connected; }
    const notification_inbox_t &notifications () const noexcept { return _notifications; }
