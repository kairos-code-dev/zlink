...
메시징 개념의 깊은 설명은 [코어 가이드](https://kairos-code-dev.github.io/zlink/core/ko/guide/01-overview/)가 소유하며, 이 가이드는 Java API 사용에 집중합니다.
...
자세한 내용은 [스레드 안전성](https://kairos-code-dev.github.io/zlink/core/ko/guide/11-thread-safety/)을 참고하세요.
