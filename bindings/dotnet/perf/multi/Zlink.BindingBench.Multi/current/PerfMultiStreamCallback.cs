...
internal static partial class PerfRunner
{
    ...
    private static int RunMultiStreamCallbackClient(string transport, int size,
        string endpoint)
    {
        size = Math.Max(1, size);
        ...
        int drainMs = ResolveMultiDrainMs("MULTI_STREAM_CALLBACK");
        ...
        try
        {
            ...
            PrintResult("MULTI_STREAM_CALLBACK", transport, size, throughput,
                latencyUs);
            return 0;
        }
        finally
