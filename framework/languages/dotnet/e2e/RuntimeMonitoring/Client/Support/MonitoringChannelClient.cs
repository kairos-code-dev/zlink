...
internal sealed class MonitoringChannelClient : IAsyncDisposable
{
    ...
    public Task<string[]> WaitForEvidenceAsync(
        ...
        _evidence.WaitUntilAsync(predicate, TimeSpan.FromSeconds(10), cancellationToken);
        ...
        CancellationToken cancellationToken)
    {
        ...
        while (true)
        {
            ...
            if (remaining <= TimeSpan.Zero)
                throw new TimeoutException("Timed out waiting for monitoring client evidence.");
