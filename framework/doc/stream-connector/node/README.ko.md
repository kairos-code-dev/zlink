...
| [Node 공개 계약](../../framework/common/spec/languages/node/stream-connector.ko.md) | public 타입, entrypoint 분리 |
| [Stream Connector 공통 스펙](../../framework/common/spec/stream-connector.ko.md) | **정본** — 대상 환경, transport, wire 계약 |
...
[implementation gap §4.10](../../framework/common/spec/implementation-gap.ko.md)에 기록한다.
