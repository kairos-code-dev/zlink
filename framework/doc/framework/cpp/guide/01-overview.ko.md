...
> C++ 표면의 자세한 계약은 [spec/](../../common/spec/languages/cpp/cpp-framework-interfaces.ko.md) 문서가
...
이 가이드가 설명하는 표면은 [spec/](../../common/spec/languages/cpp/cpp-framework-interfaces.ko.md) 의 계약을
