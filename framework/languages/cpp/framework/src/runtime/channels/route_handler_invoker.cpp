    ...
    runtime::handler_coroutine_executor ().submit<zlink::message_t> (
      ...
      try {
        ...
        co_return result_t<zlink::message_t>::success (
          (co_await runtime::await_task_result (std::move (route_task)))
            .value ());
