...
class delete_order_projection_handler_t
{
  public:
    ...
    explicit delete_order_projection_handler_t (shopping_mall_server_role_t &server) : _server (server) {}
...
class rebuild_order_projection_handler_t
{
  public:
    ...
    explicit rebuild_order_projection_handler_t (shopping_mall_server_role_t &server) : _server (server) {}
...
class seed_pending_idempotency_handler_t
{
  public:
    ...
    explicit seed_pending_idempotency_handler_t (shopping_mall_server_role_t &server) : _server (server) {}
