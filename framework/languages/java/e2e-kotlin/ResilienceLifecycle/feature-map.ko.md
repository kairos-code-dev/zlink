...
이 디렉터리는 Config 5의 Kotlin framework 검증이다. 실행 시나리오는 public Spring starter,
...
## Kotlin public API 미지원 또는 후속 harness 필요
...
- RL-B1/RL-B2/RL-B3: timeout, retry, circuit-breaker 정책은 현재 Kotlin framework public client에 별도 retry 정책
  facade가 없다.
