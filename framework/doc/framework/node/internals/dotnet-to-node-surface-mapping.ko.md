...
| `Codecs.Use(ZLinkProtobufCodec.Default)` / `Use(ZLinkMessagePackCodec.Default)` | `codecs().use(zlinkProtobufCodec())` / `use(zlinkMessagePackCodec())` | handler-interfaces §codec |
