...
=== "Java"
    ...
    public final class UserHandlers {
        ...
        // Argument order = (payload, context?) -- context can be omitted.
        @ZLinkRequest
        ...
        // A send handler -- returns CompletionStage<Void> (no response).
        @ZLinkSend
...
=== "Java"
    ...
    public final class PriceService {
        ...
        public CompletionStage<BigDecimal> get(String symbol) {
            return client
                // The target is just one ChannelName. The reply type is specified in submit(T.class).
