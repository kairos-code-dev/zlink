...
다른 언어로 보기 — [C#/.NET](../../../dotnet/guide/server/09-stream.ko.md) · **C++** · [Java](../../../java/guide/server/09-stream.ko.md) · [Kotlin](../../../kotlin/guide/server/09-stream.ko.md) · [Node/TypeScript](../../../node/guide/server/09-stream.ko.md)
<!-- language-switch:end -->
