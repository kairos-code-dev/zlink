...
channel_message_pump_t::channel_message_pump_t (
  channel_packet_dispatcher_t dispatcher)
  : _dispatcher (std::move (dispatcher))
{
}

result_t<runtime::messaging::message_parts_t>
channel_message_pump_t::dispatch_server_message (
...
{
  return _dispatcher.dispatch_server_message (
    channel_name,
    parts,
    services,
    serializers,
