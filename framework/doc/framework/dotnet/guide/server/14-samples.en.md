---
title: "14. Picking A Sample — Start With The Example Closest To Your Problem · C#/.NET"
---
...
[Guide Home](README.en.md) | [Previous: 13. Key Type Usage Index](13-interface-catalog.en.md) | [Next: 15-e2e-testing.en.md](15-e2e-testing.en.md)
<!-- framework-adapter-nav:end -->

<!-- language-switch:start -->
View in another language — **C#/.NET** · [C++](../../../cpp/guide/server/14-samples.en.md) · [Java](../../../java/guide/server/14-samples.en.md) · [Kotlin](../../../kotlin/guide/server/14-samples.en.md) · [Node/TypeScript](../../../node/guide/server/14-samples.en.md)
<!-- language-switch:end -->
