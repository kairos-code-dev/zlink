# Node.js Location/Relocation Provider Interface Move Notice

The exact public TypeScript declarations of the Location/Relocation
Store and the official Redis provider are owned by
[Location/Relocation Provider](interfaces/08-location-maintenance.ko.md).
The Location runtime's public event and observability declarations are
in [Location, Monitoring, And Metrics](interfaces/03-location-observability.ko.md).
