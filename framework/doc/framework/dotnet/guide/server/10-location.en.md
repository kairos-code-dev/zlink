---
title: "10. Location — Auto-Connect And Object Location · C#/.NET"
---
...
View in another language — **C#/.NET** · [C++](../../../cpp/guide/server/10-location.en.md) · [Java](../../../java/guide/server/10-location.en.md) · [Kotlin](../../../kotlin/guide/server/10-location.en.md) · [Node/TypeScript](../../../node/guide/server/10-location.en.md)
<!-- language-switch:end -->
