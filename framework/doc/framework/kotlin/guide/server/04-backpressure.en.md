---
title: "4. Backpressure — When Arrival Outpaces Processing · Kotlin"
---
...
View in another language — [C#/.NET](../../../dotnet/guide/server/04-backpressure.en.md) · [C++](../../../cpp/guide/server/04-backpressure.en.md) · [Java](../../../java/guide/server/04-backpressure.en.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/server/04-backpressure.en.md)
<!-- language-switch:end -->
