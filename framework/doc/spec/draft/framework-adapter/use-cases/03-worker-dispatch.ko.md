...
[문서 목록](../README.ko.md) | [이전: Draft Use Case -- Playhouse Play To API](02-playhouse-play-to-api.ko.md) | [다음: Draft Use Case -- Domain Event Fanout](04-domain-event-fanout.ko.md)
...
# Draft Use Case -- Worker Dispatch

> 이 문서는 **구현 전 초안**이다.
> 현재 공개 계약이 아니며, worker dispatch를 `ZLink Framework` 안에서 어떻게
> 다룰지 방향을 정리한다.
...
따라서 현재 초안에서는 이 케이스를 **중요하지만 1차 MVP 고정 범위는 아님**으로
본다.
