...
route_handler_registry_t &route_handler_registry_t::add_handler (route_handler_descriptor_t descriptor,
                                                                 invoker_t invoker)
{
...
const route_handler_descriptor_t *route_handler_registry_t::find (std::string_view router_channel_id,
                                                                  runtime::messaging::message_kind_t kind,
                                                                  std::string_view packet_name) const
{
    const auto found = _handlers.find (key_t{std::string (router_channel_id), kind, std::string (packet_name)});
...
result_t<zlink::message_t> route_handler_registry_t::invoke (std::string_view router_channel_id,
                                                             runtime::messaging::message_kind_t kind,
...
{
    return invoke_async (router_channel_id, kind, packet_name, services, serializers, message, context).result ();
}
