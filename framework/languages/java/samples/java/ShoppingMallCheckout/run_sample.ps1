...
$RolePattern = "systems\.zlink\.samples\.shoppingmallcheckout\.(server\.(registry|commerceapi|orderworkflow)\.Program|client\.Program)"
...
try {
    ...
    Push-Location "../../.."
    try {
        & ./gradlew --no-daemon :zlink-framework-core:jar :zlink-framework-spring-boot-starter:jar --quiet
