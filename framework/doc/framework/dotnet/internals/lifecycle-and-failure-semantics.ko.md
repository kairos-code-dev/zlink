...
[문서 목록](../../../README.ko.md) | [이전: ZLink Framework .NET DI Capability Exposure Policy](di-capability-exposure-policy.ko.md) | [다음: ZLink Framework .NET Regression Test Matrix](regression-test-matrix.ko.md)
...
session relay binding 으로 연결한다(session binding 자체는 actor type 을 저장하지 않는다 —
