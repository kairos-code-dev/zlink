...
bool fail_pending_operation (pending_operation_t &operation,
...
private:
  ...
  friend bool detail::complete_pending_operation (
    pending_operation_t &operation) noexcept;
  friend bool detail::fail_pending_operation (
    pending_operation_t &operation,
    std::exception_ptr error) noexcept;
  friend bool detail::same_pending_operation (
    const pending_operation_t &left,
    const pending_operation_t &right) noexcept;
};
