...
다른 언어로 보기 — [C#/.NET](../../../dotnet/guide/server/09-stream.ko.md) · [C++](../../../cpp/guide/server/09-stream.ko.md) · [Java](../../../java/guide/server/09-stream.ko.md) · [Kotlin](../../../kotlin/guide/server/09-stream.ko.md) · **Node/TypeScript**
<!-- language-switch:end -->
