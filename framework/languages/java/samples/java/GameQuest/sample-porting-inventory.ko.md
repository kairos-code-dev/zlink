...
GameplayStateStore 기반 reset 보정, event delta fold, Redis replay, 실제 process 재시작 gate와 player owner Spot은 닫혔다. session actor binding과 one-way owner notify 같은 남은
