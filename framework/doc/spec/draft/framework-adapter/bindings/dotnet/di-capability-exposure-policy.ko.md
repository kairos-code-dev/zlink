...
[문서 목록](../../README.ko.md) | [이전: ZLink Framework Runtime Behavior Matrix](behavior-matrix.ko.md) | [다음: ZLink Framework Runtime Lifecycle And Failure Semantics](lifecycle-and-failure-semantics.ko.md)
<!-- framework-adapter-nav:end -->

[스펙 목차](../../../README.ko.md)

[.NET 묶음](./README.ko.md) | [인터페이스](./handler-interfaces.ko.md) | [Behavior Matrix](./behavior-matrix.ko.md) | [Lifecycle](./lifecycle-and-failure-semantics.ko.md)

# Draft -- ZLink Framework .NET DI Capability Exposure Policy
...
3. `ZLinkMissingSessionProxyFactory` 와 `ZLinkMissingSessionProxy` 는 public DI
   표면에서 제거한다.
