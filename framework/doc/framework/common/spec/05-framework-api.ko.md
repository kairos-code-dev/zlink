...
namespace의 Entry·User·Instance Spot identity claim 충돌이다.
...
| host [shutdown](01-glossary.ko.md#shutdown)으로 신규 admission이 닫힘 | one-way는 `Shutdown`, request는 shutdown 오류 |
