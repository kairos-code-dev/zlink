...
{
    return detail::get_dealer_option_value<int> (detail::native_option_handle (_socket),
...
{
    detail::set_dealer_option_value<int> (detail::native_option_handle (_socket), detail::dealer_option_id::probe,
                                          value ? 1 : 0);
}
...
{
    detail::set_dealer_option_value<int> (detail::native_option_handle (_socket),
...
{
    return peer_weight_t::value (detail::get_dealer_option_value<uint32_t> (detail::native_option_handle (_socket),
                                                                            detail::dealer_option_id::weight));
}

void dealer_socket_options_t::peer_weight (peer_weight_t value)
{
    detail::set_dealer_option_value<uint32_t> (detail::native_option_handle (_socket), detail::dealer_option_id::weight,
                                               value.value ());
}
