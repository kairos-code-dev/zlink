...
| spot node | SpotNode 생성, route/channel 연결, actor 생성, ActorGateway attach 대상 | `createSpotNode`, `SpotNode.createActor`, `attachDiscovery`, channel peer public methods | gap 없음 |
