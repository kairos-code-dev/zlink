...
- 검증: MeshNode snapshot은 MeshName, RID, lifecycle generation, descriptor revision, endpoint, component
  ...
  immutable value다.
- 세부 동작: [Runtime Monitoring §2](../spec/24-runtime-monitoring.ko.md#2-snapshot)의 source별
...
- 세부 동작: [Spot Messaging §4.1](../spec/12-spot-messaging.ko.md#41-publish-시작과-완료)과
  [Runtime Monitoring §3](../spec/24-runtime-monitoring.ko.md#3-event-identifiers)의
...
- 세부 동작: application·infrastructure claim 분리와
  [Runtime Monitoring §4~5](../spec/24-runtime-monitoring.ko.md#4-event-ordering과-coalescing)의
