...
{
    private static int RunMultiRouterRouterServer(string transport, int size)
    {
        ...
        string endpoint = MultiEndpointFor(transport, "multi-MULTI_ROUTER_ROUTER");
    ...
    private static int RunMultiRouterRouterClient(string transport, int size,
        string endpoint)
    {
        size = Math.Max(1, size);
        ...
        int drainMs = ResolveMultiDrainMs("MULTI_ROUTER_ROUTER");
        ...
        try
        {
            ...
            PrintResult("MULTI_ROUTER_ROUTER", transport, size, throughput,
                latencyUs);
            return 0;
        }
        finally
