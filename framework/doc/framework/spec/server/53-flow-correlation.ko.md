...
한 흐름이 publish로 N개 구독자에 갈라진다([Bingo](../../common/sample/bingo/README.ko.md):
...
SPOT timer, [DeliveryDispatch](../../common/sample/deliverydispatch/README.ko.md)의 timeout 재배정,
