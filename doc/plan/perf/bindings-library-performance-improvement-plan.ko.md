...
| `tls` | `MULTI_PUBSUB` | `통과(83.3%)` | `보류(16.8%)` | `보류(5.6%)` | `통과(86.4%)` | `통과(101.8%)` | `통과(91.3%)` | 256/1024B는 같은 조건 최신 재측정 C `perf_c_multi_linux_20260525_085952.txt` 대비 Rust no-code `perf_rust_multi_linux_20260525_090249.txt` 기준이다. 64/65536B는 C `perf_c_multi_linux_20260525_073540.txt` 대비 Rust `perf_rust_multi_linux_20260525_073701.txt` median 기준이다. 131072/262144B는 C `perf_c_multi_linux_20260522_154822_codex_c_multi_tls_no_stream_for_rust_20260522.txt` 대비 Rust `perf_rust_multi_linux_20260522_155342_codex_rust_multi_tls_pubsub_20260522.txt` 기준이다. client drain의 `TopicMessage` placeholder 재사용 뒤 65536B 이상은 기준선을 넘었다. 256B/1024B는 최신 재측정에서 기준보다 낮다. |
