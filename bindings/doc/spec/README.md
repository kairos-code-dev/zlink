...
[Spec Index](https://zlink.systems/core/spec/)
...
- 전체 enum 정의는
  [errno-map.md](https://zlink.systems/core/spec/core/04-errno-map/) 를 참조한다.
...
1. **Public result enum 코드 (0–706)** — 공개 C API 함수의 반환 enum 값.
   ...
   전체 정의는 [core/errno-map.md](https://zlink.systems/core/spec/core/04-errno-map/) 참조.
...
## Sample Policy
- 샘플 제작 규칙은 [`doc/spec/sample/SAMPLE_POLICY.md`](https://zlink.systems/core/spec/sample/SAMPLE_POLICY/)
  를 단일 기준 문서로 사용한다.
