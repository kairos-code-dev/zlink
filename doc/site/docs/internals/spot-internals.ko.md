...
[`doc/spec/core/service/spot.ko.md`](https://github.com/kairos-code-dev/zlink/blob/main/doc/spec/core/service/spot.ko.md)를 기준으로
본다.
...
[`doc/spec/core/service/spot.ko.md`](https://github.com/kairos-code-dev/zlink/blob/main/doc/spec/core/service/spot.ko.md)의 Actor 계약 절을 본다.
