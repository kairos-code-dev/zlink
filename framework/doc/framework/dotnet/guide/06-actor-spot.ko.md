...
| `OnLeaveActorAsync(actor, ct)` | user Spot 의 `Context.leaveActor(actor)` 또는 framework leave | ✅ | ✅ |
...
### ③ user Spot — admission·leave·disconnect (`BingoRoom : IZLinkSpot<PlayerActor>`)
