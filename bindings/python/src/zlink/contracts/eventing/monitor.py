...
from ..core.options import AutoHwmRecalcReason
...
from ..._runtime.sockets.socket_base import _enter_callback, _leave_callback
...
class MonitorSocket(_BaseMonitor):
    ...
    def recv(self, *, flags=0):
        """Drain the next monitor event.

        Returns ``None`` when no event is pending (EAGAIN). Value-return form
