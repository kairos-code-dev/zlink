---
title: "4. Backpressure — When Arrival Outpaces Processing · Java"
---
...
View in another language — [C#/.NET](../../../dotnet/guide/server/04-backpressure.en.md) · [C++](../../../cpp/guide/server/04-backpressure.en.md) · **Java** · [Kotlin](../../../kotlin/guide/server/04-backpressure.en.md) · [Node/TypeScript](../../../node/guide/server/04-backpressure.en.md)
<!-- language-switch:end -->
