[코어 가이드](../../../core/doc/guide/01-overview.ko.md)
...
않도록 [코어 가이드](../../../core/doc/guide/01-overview.ko.md)가 한 번만 다루며, 각 언어 가이드는
...
- **메시징이 처음이다** → 코어 [개요](../../../core/doc/guide/01-overview.ko.md)와
  [소켓 패턴](../../../core/doc/guide/03-0-socket-patterns.ko.md)을 먼저 본 뒤 언어 가이드로 오세요.
...
> [코어 C API 가이드](../../../core/doc/guide/02-core-api.ko.md)를 봅니다.
...
> 소켓 패턴별 사용법, Registry·Discovery·SPOT·Actor, 옵션·TLS·모니터링·폴러/타이머·
