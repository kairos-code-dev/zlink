...
const { createMetricCollector, createPayload, createRunId, currentEpochNs, decodeMetricHeader, sleepImmediate, summarizeMetrics, stampPayload, } = require('../common/perf_metrics');
