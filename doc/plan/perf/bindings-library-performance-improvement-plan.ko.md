...
| `wss` | `MULTI_SPOT` | `보류(59.7%)` | `보류(57.5%)` | `보류(58.5%)` | `통과(131.8%)` | `통과(174.0%)` | `통과(96.3%)` | 64/256B는 같은 조건 제한 재측정 C `perf_c_multi_linux_20260525_094522.txt` 대비 Rust `perf_rust_multi_linux_20260525_094751.txt` 기준이다. 1024~131072B는 C `perf_c_multi_linux_20260522_152936_codex_c_multi_wss_no_stream_for_rust_20260522.txt` 대비 Rust `perf_rust_multi_linux_20260524_201915.txt` 기준이다. 262144B는 같은 조건 제한 재측정 C `perf_c_multi_linux_20260525_014732.txt` 345.5K 대비 Rust `perf_rust_multi_linux_20260525_014728.txt` 332.585K median 기준이다. SPOT client 복사 제거 + 4-worker drain 재측정으로 65536B/131072B는 통과권에 올랐고, 262144B도 최신 같은 조건 C 기준으로 통과한다. wss 64/256B는 기본 recv worker를 2개로 좁혀 기존보다 올랐지만 아직 기준보다 낮다. 1024B는 2-worker 후보에서 내려가므로 기존 기본값을 유지한다. |
