...
ZLINK_BINGO_PROTOBUF_CODEC_TRAITS (zlink::samples::bingo::ensure_player_actor_res_t)
...
ZLINK_BINGO_PROTOBUF_CODEC_TRAITS (zlink::samples::bingo::allocate_bingo_room_req_t)
ZLINK_BINGO_PROTOBUF_CODEC_TRAITS (zlink::samples::bingo::allocate_bingo_room_res_t)
