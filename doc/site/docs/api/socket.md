...
| Socket Type | Spec |
|-------------|------|
| PAIR | [pair.md](socket.md) |
| DEALER | [dealer.md](socket.md) |
| ROUTER | [router.md](socket.md) |
| PUB | [pub.md](socket.md) |
| SUB | [sub.md](socket.md) |
| XPUB | [xpub.md](socket.md) |
| XSUB | [xsub.md](socket.md) |
| STREAM | [stream.md](socket.md) |
...
(`zlink_stream_packet_handler()`) — see [stream.md](socket.md). The socket
...
See [stream.md](socket.md) for the full contract.
