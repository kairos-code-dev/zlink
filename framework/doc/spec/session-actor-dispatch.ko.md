...
구체 .NET 시그니처는
[bindings/dotnet/session-actor-dispatch.ko.md](../../languages/dotnet/doc/spec/session-actor-dispatch.ko.md)
§3을 참고한다.
...
[handler-interfaces.ko.md §4.4](../../languages/dotnet/doc/spec/handler-interfaces.ko.md)와
[bindings/dotnet/session-actor-dispatch.ko.md](../../languages/dotnet/doc/spec/session-actor-dispatch.ko.md)
§7-8을 참고한다.
