...
public final class Program {
    ...
    private static void assertActorEvidence(String actorUrl) {
        ...
        require(!containsScenario(evidence, "TA-B3-route-disconnected"), "TA-B3 disconnected route reached actor");
    }
