...
void define_spot_exports (napi_env env, napi_value exports)
{
    napi_property_descriptor descs[] = {
      ...
      ZLINK_METHOD ("spotNodeProcessRoutedRouter", spot_node_process_routed_router),
      ZLINK_METHOD ("spotNodeTryProcessRoutedRouterParts",
                    spot_node_try_process_routed_router_parts),
