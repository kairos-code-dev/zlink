    ...
    private static boolean isKnownCommand(int command) {
        return switch (command) {
            case ServiceWireConstants.COMMAND_HELLO,
                 ...
                 ServiceWireConstants.COMMAND_TRANSFER_READY,
                 ServiceWireConstants.COMMAND_TRANSFER_DATA,
                 ServiceWireConstants.COMMAND_TRANSFER_ACK,
                 ServiceWireConstants.COMMAND_REPLY_RELAY,
                 ServiceWireConstants.COMMAND_TRANSFER_SEAL,
                 ServiceWireConstants.COMMAND_TRANSFER_COMPLETE,
                 ...
                 ServiceWireConstants.COMMAND_TRANSFER_PREPARE,
                 ServiceWireConstants.COMMAND_TRANSFER_RESERVED,
                 ServiceWireConstants.COMMAND_SESSION_TRANSFER_SEAL,
                 ServiceWireConstants.COMMAND_SESSION_TRANSFER_SEALED,
                 ServiceWireConstants.COMMAND_SESSION_TRANSFER_ROUTE,
                 ServiceWireConstants.COMMAND_SESSION_TRANSFER_ROUTED,
