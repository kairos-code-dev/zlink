#!/usr/bin/env python3
"""Compatibility runner for java perf.

Delegates to bindings/perf/run_policy_bench.py while keeping the same CLI shape
used by perf wrappers.
"""
...
def main(argv: List[str]) -> int:
    ap = argparse.ArgumentParser(description="java perf compatibility runner")
    ...
    if args.duration > 0 and suite == "multi":
