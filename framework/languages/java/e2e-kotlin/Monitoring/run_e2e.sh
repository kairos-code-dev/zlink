...
pids=()
role_pattern='systems\.zlink\.e2e\.kotlin\.monitoring\.ProgramKt'
...
export ZLINK_KOTLIN_E2E_BUILD_DIR="${ZLINK_KOTLIN_E2E_BUILD_DIR:-${HOME}/.cache/zlink/kotlin-e2e/Monitoring}"
export ZLINK_KOTLIN_E2E_GRADLE_CACHE="${ZLINK_KOTLIN_E2E_GRADLE_CACHE:-${HOME}/.cache/zlink/kotlin-e2e/Monitoring-gradle-cache}"
...
app_bin() {
  echo "${ZLINK_KOTLIN_E2E_BUILD_DIR}/install/monitoring-kotlin/bin/monitoring-kotlin"
}
...
ZLINK_KOTLIN_E2E_ROLE=validation \
ZLINK_KOTLIN_E2E_LOG_DIR="${log_dir}" \
