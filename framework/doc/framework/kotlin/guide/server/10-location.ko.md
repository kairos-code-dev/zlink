---
title: "10. Location — 자동 연결과 Object 위치 · Kotlin"
---
...
다른 언어로 보기 — [C#/.NET](../../../dotnet/guide/server/10-location.ko.md) · [C++](../../../cpp/guide/server/10-location.ko.md) · [Java](../../../java/guide/server/10-location.ko.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/server/10-location.ko.md)
<!-- language-switch:end -->
