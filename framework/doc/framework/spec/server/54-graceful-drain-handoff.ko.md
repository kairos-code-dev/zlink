...
[Java `ZLinkStreamCloseReason`](../stream-connector/languages/java/03-stream-connector.ko.md),
[TypeScript `closeReason` union](../stream-connector/languages/typescript/03-stream-connector.ko.md)); .NET/C++/Kotlin connector도 같은
