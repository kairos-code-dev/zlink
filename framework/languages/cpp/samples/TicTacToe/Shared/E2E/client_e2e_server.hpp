...
build_client_e2e_api_server (sample_topology_t topology)
{
  auto app = zlink::framework::app_t::create ();
  app.add_zlink_framework (
    [topology](zlink::framework::zlink_framework_options_t &options) {
...
inline void
run_client_e2e_stream_server (zlink::stream_socket_t &server,
