...
| `owner_lease_renew_timeout` | 3s | The ceiling to wait for one renewal request |
...
**What happens during a Store outage splits into two.** `store_failure_grace` is how long the
