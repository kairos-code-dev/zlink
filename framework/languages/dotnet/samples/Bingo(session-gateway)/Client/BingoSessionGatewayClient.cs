...
public sealed class BingoSessionGatewayClient
{
    public async ValueTask<BingoSessionGatewayClientResult> RunAsync(
        BingoSessionGatewayClientOptions options,
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            var result = new BingoSessionGatewayClientResult(
                auth.ToArray(),
                matches.ToArray(),
                started,
                ended,
            ...
            BingoSessionGatewayClientAssertions.Validate(result);
            return result;
        }
        finally
        {
...
public sealed record BingoSessionGatewayClientResult(
...
internal static class BingoSessionGatewayClientAssertions
{
    public static void Validate(BingoSessionGatewayClientResult result)
    {
