...
class ReadmeAlignmentTests(unittest.TestCase):
    def test_python_readme_exists_and_references_binding_policy(self):
        ...
        self.assertIn("get_property", readme)
        self.assertIn("ref_count", readme)
        self.assertIn("on_packet", readme)
        self.assertIn("on_send_ready", readme)
        self.assertIn("on_dispatch_event", readme)
        self.assertIn("receive_subscription_event", readme)
        self.assertIn("send_service", readme)
        self.assertIn("request_service", readme)
        self.assertIn("attach_router", readme)
        self.assertIn("attach_pubsub", readme)
        self.assertIn("service_attachment_count", readme)
        self.assertIn("service_attachment_at", readme)
        self.assertIn("node_monitor_recv", readme)
