...
{
  public:
    explicit leave_room_handler_t (bingo_room_directory_t &rooms) : _rooms (rooms) {}

    leave_room_res_t handle (const leave_room_req_t &request, const std::string &actor_id)
    {
...
class bingo_room_actor_left_handler_t
{
  public:
    ...
    void
    handle (const bingo_room_t &, const player_actor_t &, const zlink::framework::spot_actor_change_result_t &) const
    {
    }
};
