...
[문서 목록](../README.ko.md) | [이전: Draft Use Case -- Cache Invalidation And Config Refresh](05-cache-invalidation-and-config-refresh.ko.md) | [다음: Draft Use Case -- Real Time Notification Fanout](07-real-time-notification-fanout.ko.md)
...
# Draft Use Case -- Stage State Sync

> 이 문서는 **구현 전 초안**이다.
> 현재 공개 계약이 아니며, 게임 stage 또는 실시간 상태 동기화 use case를
> 설명하기 위한 초안이다.
