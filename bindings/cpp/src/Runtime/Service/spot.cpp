...
std::optional<received_t> spot_t::recv_routed_optional (recv_flags_t flags_)
{
    ...
    if (has_node_rid && has_spot_rid)
        zlink::detail::received_access_t::set_spot_spot_send_context (
          received, _impl->handle);
