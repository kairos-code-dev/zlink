---
title: "5. Channel Messaging — request · send · pub/sub · Kotlin"
---

<!-- generated:start -->
<!-- 이 파일은 `common/guide/server/05-channel-messaging.ko.md`에서 생성한다. 직접 고치지 않는다.
...
다른 언어로 보기 — [C#/.NET](../../../dotnet/guide/server/05-channel-messaging.ko.md) · [C++](../../../cpp/guide/server/05-channel-messaging.ko.md) · [Java](../../../java/guide/server/05-channel-messaging.ko.md) · **Kotlin** · [Node/TypeScript](../../../node/guide/server/05-channel-messaging.ko.md)
<!-- language-switch:end -->
...
분리하는 이유다([02. Getting Started](02-getting-started.ko.md) §7).
...
- 이 챕터 계약의 실행 검증 예문(client/handler/filter/codec):
  [13. Interface 카탈로그](13-interface-catalog.ko.md) §1
