...
Global ActorId·SpotId, exact ActorRef·SpotRef, User Spot manager의 명시적인 create/get-or-create,
...
global ID로 current authority를 resolve하며 process-local handle이나 별도 address를 사용하지 않는다.
