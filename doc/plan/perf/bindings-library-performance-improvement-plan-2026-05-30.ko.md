...
`MULTI_ROUTER_ROUTER tcp 1024/65536B`가 통과권으로 회복했다. 나머지 잔류 미달은 14개다. Multi 잔여 항목은
...
| `tcp` | `MULTI_ROUTER_ROUTER` | `미달(39.8%)` | `통과(42.3%)` | `통과(47.0%)` | `통과(40.3%)` | `통과(42.1%)` | `통과(46.0%)` | 256B는 current C/Go 제한 재측정 C `perf_c_multi_linux_20260604_213420_go_multi_rr_tcp256_c_recheck_20260604.txt`, Go `perf_go_multi_linux_20260604_213420_go_multi_rr_tcp256_recheck_20260604.txt` 기준으로 통과했다. 64/1024/65536B는 Go routed multi client active poll wait deadline 정렬 뒤 Go `perf_go_multi_linux_20260605_005504_go_multi_rr_tcp_deadline_probe_20260605.txt`, C `perf_c_multi_linux_20260605_005612_go_multi_rr_tcp_deadline_c_recheck_20260605.txt` 기준. 64B는 기준에 근접했지만 아직 못 닿아 미달한다. 나머지는 C full/Go multi full. |
