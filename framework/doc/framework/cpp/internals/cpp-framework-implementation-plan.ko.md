...
[문서 목록](../../../README.ko.md) | [이전: Draft -- ZLink Framework For C++](../README.ko.md) | [다음: Draft -- ZLink Framework C++ Policy](cpp-framework-policy.ko.md)
<!-- framework-adapter-nav:end -->

[스펙 목차](../../common/README.ko.md)

[C++ 묶음](../README.ko.md) | [C++ 정책](cpp-framework-policy.ko.md) | [Application Framework](../spec/cpp-application-framework.ko.md) | [Framework 인터페이스](../spec/cpp-framework-interfaces.ko.md) | [HTTP Client](../../../http-client/cpp/spec/cpp-http-client.ko.md)
...
- CAPI timer와 CAPI SPOT dispatch event 후 recv 경계를 사용하므로 별도 실행 직렬화 queue를 추가하지 않는다.
