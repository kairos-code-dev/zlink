...
[문서 목록](../../../../../README.ko.md) | [이전: ZLink Framework NestJS Monitoring](nestjs-monitoring.ko.md)
<!-- framework-adapter-nav:end -->

[스펙 목차](../../../../node/README.ko.md)

[Node.js 묶음](../../../../node/README.ko.md) | [인터페이스](handler-interfaces.ko.md) | [channel](nestjs-channel-messaging.ko.md) | [SPOT](nestjs-spot.ko.md) | [STREAM](nestjs-stream.ko.md)
...
[^heartbeat]: heartbeat는 서비스의 유효 상태를 일정 주기로 Registry에 알리는 신호다. 일정 시간 안에 도착하지 않으면 그 서비스는 lost 상태로 간주된다.
