...
bool
no_route_internal_packet_dispatcher_t::can_handle_send (
...
bool
no_route_internal_packet_dispatcher_t::can_handle_request (
  std::string_view packet_name) const
{
  (void) packet_name;
  return false;
...
result_t<void>
no_route_internal_packet_dispatcher_t::dispatch_send (
...
no_route_internal_packet_dispatcher_t::dispatch_request (
...
void
composite_route_internal_packet_dispatcher_t::add (
...
bool
composite_route_internal_packet_dispatcher_t::can_handle_send (
  std::string_view packet_name) const
{
...
bool
composite_route_internal_packet_dispatcher_t::can_handle_request (
  std::string_view packet_name) const
{
...
result_t<void>
composite_route_internal_packet_dispatcher_t::dispatch_send (
  const route_received_packet_t &received) const
{
  auto header =
    runtime::messaging::envelope_codec_t {}.decode_header (received.parts);
  if (!header) {
    return result_t<void>::failure (
      header.error_kind (),
...
result_t<zlink::message_t>
composite_route_internal_packet_dispatcher_t::dispatch_request (
  const route_received_packet_t &received,
  const runtime::messaging::envelope_header_t &header) const
{
...
composite_route_internal_packet_dispatcher_t::resolve_send (
  std::string_view packet_name) const
{
...
const route_internal_packet_dispatcher_t *
composite_route_internal_packet_dispatcher_t::resolve_request (
  std::string_view packet_name) const
{
  for (const auto *dispatcher : _dispatchers) {
