...
| `Client/Scenarios/RmC9BackpressureScenario.cs` | `Client/src/main/java/systems/zlink/e2e/registrymessaging/client/Scenarios/RmC9BackpressureScenario.java` | scenario | gap | bounded timeout/backpressure smoke와 recovery는 검증한다. `.NET`의 low-HWM client socket 설정은 Java public API에 없어 포팅하지 않았다. |
...
| `Server/Provider/Handlers/ProviderHandlers.cs` | `Server/Provider/src/main/java/systems/zlink/e2e/registrymessaging/provider/Handlers/ProfileRequestHandler.java`, `Server/Provider/src/main/java/systems/zlink/e2e/registrymessaging/provider/Handlers/ProfileCommandHandler.java`, `Server/Provider/src/main/java/systems/zlink/e2e/registrymessaging/provider/Handlers/PayloadRequestHandler.java`, `Server/Provider/src/main/java/systems/zlink/e2e/registrymessaging/provider/Handlers/RoutePingHandler.java` | handlers | done | request, send, payload, route handler 분리. |
...
| `Server/Workflow/Handlers/WorkflowHandlers.cs` | `Server/Workflow/src/main/java/systems/zlink/e2e/registrymessaging/workflow/Handlers/ProfileRequestHandler.java`, `Server/Workflow/src/main/java/systems/zlink/e2e/registrymessaging/workflow/Handlers/ProfileCommandHandler.java`, `Server/Workflow/src/main/java/systems/zlink/e2e/registrymessaging/workflow/Handlers/RoutePingHandler.java`, `Server/Workflow/src/main/java/systems/zlink/e2e/registrymessaging/workflow/Handlers/WorkflowRequestHandler.java` | handlers | done | workflow role handler 분리. |
