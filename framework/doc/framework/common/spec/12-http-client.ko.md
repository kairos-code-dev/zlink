...
> [`doc/http-client/spec/`](../../../http-client/spec/README.ko.md)이 이어서 소유한다. 이 문서는
> 그중 **framework와 맞물리는 축**을 고정한다.
>
> 언어별 정확한 타입과 시그니처는 `languages/<lang>/04-http-client.ko.md`가 고정한다(**작성 예정**).
> 그때까지는 [`doc/http-client/spec/language-interfaces.ko.md`](../../../http-client/spec/language-interfaces.ko.md)가
> 그 자리를 대신한다.
...
|---|---|---|
| 패키지 | 별도 | 별도 |
| 계약 소유 | framework 공통 스펙([32](32-stream-connector.ko.md)) | framework 공통 스펙(이 문서) |
...
[`doc/http-client/spec/03-request-builder.ko.md`](../../../http-client/spec/03-request-builder.ko.md)가
소유한다.
...
([11 §6](11-channel-messaging.ko.md)). 같은 codec extension 객체를 양쪽에 각각 등록할 수 있으나,
**등록은 host마다 따로 해야 한다.**
...
세부 매핑은
[`doc/http-client/spec/09-error-model.ko.md`](../../../http-client/spec/09-error-model.ko.md)가
소유한다.
