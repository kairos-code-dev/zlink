---
title: "14. 샘플 고르기 — 내 문제에 가까운 예제부터 · C#/.NET"
---
...
[가이드 홈](README.ko.md) | [이전: 13. 주요 interface 사용 색인](13-interface-catalog.ko.md) | [다음: 15. E2E 테스트 — client로 시스템 전체를 검증하기](15-e2e-testing.ko.md)
