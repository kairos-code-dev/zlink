...
{
    static void *
    create (ctx_t *ctx_, zlink_auto_connect_type_t auto_connect_type_, const char *channel_name_);
    static discovery_t *from_handle (void *discovery_);
    static int connect_registry (discovery_t *discovery_, const char *registry_endpoint_);
    static int set_tls_client (discovery_t *discovery_,
                               const char *ca_cert_,
                               const char *hostname_,
                               int trust_system_);
    static int
    set_option (discovery_t *discovery_, int option_, const void *optval_, size_t optvallen_);
    static int get_option (discovery_t *discovery_, int option_, void *optval_, size_t *optvallen_);
    static int set_routing_id (discovery_t *discovery_, const void *data_, size_t size_);
    ...
    static int
    member_peers (discovery_t *discovery_, zlink_member_peer_entry_t *entries_, size_t *count_);
    ...
    static int add_observer (discovery_t *discovery_, discovery_observer_t *observer_);
    static int remove_observer (discovery_t *discovery_, discovery_observer_t *observer_);
    static void upsert_service_summary (discovery_t *discovery_,
    ...
    static service_public_api_guard_t &public_api_guard (discovery_t *discovery_);
    static bool bootstrap_socket_config_locked (discovery_t *discovery_, bool routing_id_locked_);
    static void apply_socket_option_to_sub_socket (discovery_t *discovery_,
                                                   int option_,
                                                   const void *optval_,
                                                   size_t optvallen_);
    static discovery_bootstrap_runtime_t *bootstrap_runtime (discovery_t *discovery_);
    static discovery_uplink_runtime_t *uplink_runtime (discovery_t *discovery_);
    static int ensure_control_task_active (discovery_t *discovery_);
    static void emit_ready_changed (discovery_t *discovery_, uint32_t ready_count_);
    static int ensure_topology_reporters (discovery_t *discovery_);
    static socket_base_t *create_tracked_socket (discovery_t *discovery_, int socket_type_);
    static int
    close_tracked_socket (discovery_t *discovery_, socket_base_t *&socket_, int timeout_ms_);
    static int close_tracked_socket_and_wait (discovery_t *discovery_,
                                              socket_base_t *&socket_,
                                              int timeout_ms_);
    static bool should_publish_summary_entry (discovery_t *discovery_,
                                              const zlink_registry_topology_entry_t &entry_);
    static void collect_dirty_summary_entries (discovery_t *discovery_,
                                               std::vector<zlink_registry_topology_entry_t> *out_);
    static void
    mark_summary_entries_sent (discovery_t *discovery_,
    ...
    static void
    mark_registered_service_heartbeat (discovery_t *discovery_,
