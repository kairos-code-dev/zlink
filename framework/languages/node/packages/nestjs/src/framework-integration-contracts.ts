...
export interface ZLinkSpotNodeOptions {
  ...
  readonly spotFactoryRegistrations?: Readonly<Record<
    string,
    ZLinkObjectFactoryRegistration<ZLinkSpot>
  >>;
...
interface ZLinkObjectFactoryRegistration<T, TImplementation = T> {
