...
{
    detail::throw_if_failed<config_error_t> (static_cast<config_result_t> (zlink_proxy (
      detail::native_handle (frontend_), detail::native_handle (backend_), detail::native_handle (capture_))));
}
