...
std::string
error_code_name (framework_error_kind_t kind)
{
  switch (kind) {
...
channel_reply_writer_t::create_reply_header (
...
channel_reply_writer_t::reply_raw_envelope (
