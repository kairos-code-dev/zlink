...
internal static class AtdD2RemoteSpotAwaitScenario
{
    public static async Task RunAsync(IZlinkStreamConnector client)
    {
        ...
        var requestId = $"ATD-D2-{Guid.NewGuid():N}";
        ...
        ScenarioAssert.That(reply.ScenarioId == "ATD-D2", "ATD-D2 reply scenario mismatch.");
        ScenarioAssert.That(reply.NodeRid == "play-a", "ATD-D2 caller continuation node mismatch.");
