---
title: "8. Session과 Actor binding · Java"
---
...
다른 언어로 보기 — [C#/.NET](../../../dotnet/guide/server/08-actor-session.ko.md) · [C++](../../../cpp/guide/server/08-actor-session.ko.md) · **Java** · [Kotlin](../../../kotlin/guide/server/08-actor-session.ko.md) · [Node/TypeScript](../../../node/guide/server/08-actor-session.ko.md)
<!-- language-switch:end -->
