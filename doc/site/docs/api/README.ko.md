...
| [socket/](socket.ko.md) | 소켓 스펙 (공통 + 타입별) |
...
| [service/README.ko.md](spot.ko.md) | 서비스 계층 공통 개념과 문서 책임 분리 |
| [service/registry.ko.md](registry.ko.md) | 서비스 레지스트리 생성, 구성, 클러스터링 |
| [service/discovery.ko.md](discovery.ko.md) | 서비스 디스커버리, 구독, 피어 조회 |
| [service/spot.ko.md](spot.ko.md) | SPOT 토픽 기반 PUB/SUB, routed 메시징 |
...
| `zlink_socket_msg_handler_fn` | [socket/](socket.ko.md) | raw `STREAM` raw 수신 콜백 |
...
| 타입 | 정의 위치 | 설명 |
|------|-----------|------|
| [`zlink_socket_msg_handler_fn`](socket.ko.md) | socket/ | raw `STREAM`의 raw 수신 콜백 타입 |
| [`zlink_stream_packet_handler_fn`](socket.ko.md) | socket/ | raw `STREAM`의 packet 수신 콜백 타입 |
| [`zlink_reply_handler_fn`](socket.ko.md) | socket/ | 비동기 request-reply 완료 콜백 |
| [`zlink_spot_handler_fn`](spot.ko.md) | service/spot.ko.md | SPOT routed 메시지 dispatch 콜백 |
| [`zlink_spot_dispatch_event_handler_fn`](spot.ko.md) | service/spot.ko.md | SPOT dispatch 이벤트 콜백 |
| [`zlink_monitor_handler_fn`](./monitoring.ko.md) | monitoring.ko.md | 소켓 모니터 이벤트 콜백 |
| [`zlink_send_ready_handler_fn`](socket.ko.md) | socket/ | send-ready 전환 콜백 |
