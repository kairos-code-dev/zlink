...
using OutgameRequestHandler = std::function<void (const std::string &session_key,
                                                  const std::string &op,
...
class ZoneService
{
  public:
    ...
    void on_outgame_response (const std::string &session_key,
                              const std::string &req_id,
  ...
  private:
    void handle_enter (const std::string &session_key,
                       const std::string &req_id,
                       const std::vector<std::string> &args);
    void handle_move (const std::string &session_key,
                      const std::string &req_id,
                      const std::vector<std::string> &args);
    ...
    void handle_outgame (const std::string &session_key,
                         const std::string &req_id,
                         const std::vector<std::string> &args);
