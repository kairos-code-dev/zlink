...
[문서 목록](../../../../README.ko.md) | [이전: ZLink Framework .NET SPOT Samples](spot-samples.ko.md) | [다음: ZLink Stream Connector For .NET](streaming-client.ko.md)
...
> 이 문서는 실행 가능한 sample 중심 문서다. 기술 선택 기준은
> [13-grpc-alternative](../13-grpc-alternative.ko.md)가 맡고, 이 문서는 STREAM 등록과
> session packet 흐름을 따라 하는 데 집중한다.
...
- session callback payload 는 framework `ZLinkMessage` 다. application 은 이 값을
  decode 하거나 다른 framework API 에 넘긴다.
