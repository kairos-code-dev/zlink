...
std::uint64_t
channel_pending_requests_t::next_request_seq ()
{
...
bool
channel_pending_requests_t::register_request (std::uint64_t request_seq,
...
channel_pending_requests_t::remove (std::uint64_t request_seq)
{
...
bool
channel_pending_requests_t::contains (std::uint64_t request_seq) const
{
  return _pending.find (request_seq) != _pending.end ();
}

void
channel_pending_requests_t::clear () noexcept
{
  _pending.clear ();
}

std::size_t
channel_pending_requests_t::count () const noexcept
{
