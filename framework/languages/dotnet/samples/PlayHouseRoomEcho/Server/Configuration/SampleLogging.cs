...
internal static class SampleLogging
{
    ...
    public static ILoggerFactory CreateLoggerFactory(SampleSettings settings, string role)
    {
        return LoggerFactory.Create(logging => Configure(logging, settings, role));
    }
}
