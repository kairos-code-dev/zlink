...
typedef enum zlink_discovery_monitor_event_e
{
    ...
    ZLINK_DISCOVERY_PROVIDERS_CHANGED = ZLINK_DISCOVERY_MONITOR_EVENT_PROVIDERS_CHANGED,
...
typedef enum zlink_service_event_internal_e
{
    ...
    ZLINK_SERVICE_EVENT_INTERNAL_DISCOVERY_SERVICE_UP = ZLINK_DISCOVERY_MONITOR_EVENT_SERVICE_UP,
    ...
    ZLINK_SERVICE_EVENT_INTERNAL_ALL = ZLINK_SERVICE_EVENT_INTERNAL_ERROR
...
typedef zlink_service_event_detail_mask_t zlink_service_event_detail_mask_internal_t;
