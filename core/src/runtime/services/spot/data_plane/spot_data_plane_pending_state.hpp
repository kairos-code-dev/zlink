...
#ifndef ZLINK_SPOT_DATA_PLANE_PENDING_STATE_HPP_INCLUDED
#define ZLINK_SPOT_DATA_PLANE_PENDING_STATE_HPP_INCLUDED
...
struct spot_data_plane_pending_state_t
{
    spot_data_plane_pending_state_t () : next_message_id (0) {}
