...
inline int recv_dealer_header_flags (
  void *socket,
                              ...
                              latency_stats_t *out_latency)
{
    ...
    std::thread receiver_thread ([&] () {
        ...
        while (true) {
            ...
            bool header_ok = false;
            const int recv_rc = recv_dealer_header_flags (
            ...
            if (recv_rc > 0) {
                ...
                for (;;) {
                    ...
                    const int burst_rc = recv_dealer_header_flags (
...
int main (int argc, char **argv)
{
    return run_standard_bench_main (
      argc, argv, "DEALER_DEALER", run_dealer_dealer);
}
