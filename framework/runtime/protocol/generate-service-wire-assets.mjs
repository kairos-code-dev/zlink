...
console.log(`${check ? "verified" : "generated"} service wire assets: commands=${commands.length} flags=${flags.length} fixtures=${fixtures.canonical.length + fixtures.malformed.length}`);
