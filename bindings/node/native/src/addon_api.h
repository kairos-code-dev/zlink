...
napi_value spot_node_service_attachment_count(napi_env env, napi_callback_info info);
napi_value spot_node_service_attachment_at(napi_env env, napi_callback_info info);
