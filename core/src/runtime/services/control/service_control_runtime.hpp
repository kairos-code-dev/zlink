...
#ifndef __ZLINK_SERVICE_CONTROL_RUNTIME_HPP_INCLUDED__
#define __ZLINK_SERVICE_CONTROL_RUNTIME_HPP_INCLUDED__
...
{
class ctx_t;
typedef void (service_control_task_fn) (void *);
...
class service_control_runtime_t
{
  public:
    ...
    uint64_t add_periodic_task (service_control_task_fn *fn_,
                                void *arg_,
  ...
  private:
    ...
    ZLINK_NON_COPYABLE_NOR_MOVABLE (service_control_runtime_t)
};
}
