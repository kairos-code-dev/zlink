...
| `tcp` | `MULTI_STREAM` | `통과(82.6%)` | `통과(98.3%)` | `통과(96.5%)` | `보류(76.9%)` | `해당 없음` | `해당 없음` | 64B는 C `perf_c_multi_linux_20260522_150329_codex_c_multi_tcp_stream_clients100_for_rust_20260522.txt`, Rust `perf_rust_multi_linux_20260522_150351_codex_rust_multi_tcp_stream_clients100_20260522.txt` 기준이다. 256B/1024B는 같은 조건 제한 재측정 C `perf_c_multi_linux_20260525_052620.txt` 대비 Rust `perf_rust_multi_linux_20260525_052625.txt` median 기준이고, 65536B는 C `perf_c_multi_linux_20260525_053424.txt` 대비 Rust `perf_rust_multi_linux_20260525_053431.txt` median 기준이다. 기본 STREAM clients=10000은 thread/CPU 부담이 커서 먼저 clients=100으로 제한해 같은 조건 비교를 남겼다. 64B/256B/1024B는 단순 one-way 기준을 넘고, 65536B는 최신 재측정에서도 80% 하한 바로 아래라 보류한다. |
