---
title: "5. Channel Messaging — request · send · pub/sub · C#/.NET"
---
...
다른 언어로 보기 — **C#/.NET** · [C++](../../../cpp/guide/server/05-channel-messaging.ko.md) · [Java](../../../java/guide/server/05-channel-messaging.ko.md) · [Kotlin](../../../kotlin/guide/server/05-channel-messaging.ko.md) · [Node/TypeScript](../../../node/guide/server/05-channel-messaging.ko.md)
<!-- language-switch:end -->
