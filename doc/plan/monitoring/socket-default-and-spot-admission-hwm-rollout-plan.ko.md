...
### 2026-05-01 12:35 KST - 단계 10

- 수정 파일: `bindings/c/perf/multi/common/perf_multi_runtime.hpp`, `bindings/c/samples/spot_routed_request_sample.c`, `core/src/services/spot/spot_node_handles.cpp`, `core/src/services/spot/spot_pub.cpp`, `core/src/services/spot/spot_sub_option.cpp`, `doc/plan/monitoring/socket-default-and-spot-admission-hwm-rollout-plan.ko.md`
- 실행 명령: `bindings/c/samples/run_samples.sh`, `ctest --test-dir bindings/c/build --output-on-failure`, `PERF_DISABLE_RESOURCE_METRICS=1 bindings/c/perf/run_benchmarks.sh --pattern ALL --runs 1 --duration 1 --msg-sizes 64 --transports tcp --reuse-build --results-tag socket_default_spot_admission_single_smoke`, `PERF_DISABLE_RESOURCE_METRICS=1 PERF_MULTI_RUN_COOLDOWN_MS=0 bindings/c/perf/run_benchmarks_multi.sh --pattern ALL --runs 1 --duration 1 --clients 2 --msg-sizes 64 --transports tcp --connect-concurrency 2 --transport-transition-ms 0 --pattern-transition-ms 0 --reuse-build --results-tag socket_default_spot_admission_multi_smoke`, `PERF_DISABLE_RESOURCE_METRICS=1 bindings/c/perf/run_benchmarks_multi.sh --pattern SPOT --runs 1 --duration 2 --clients 100 --msg-sizes 64,1024,65536,262144 --transports tcp,tls --reuse-build --results-tag socket_default_spot_admission_multi_spot`, `PERF_DISABLE_RESOURCE_METRICS=1 bindings/c/perf/run_benchmarks_multi.sh --pattern SPOT_REQREP --runs 1 --duration 2 --clients 100 --msg-sizes 64,256,1024 --transports tcp,tls --reuse-build --results-tag socket_default_spot_admission_multi_spot_reqrep`, `PERF_DISABLE_RESOURCE_METRICS=1 bindings/c/perf/run_benchmarks_multi.sh --pattern SPOT_SENDSEND --runs 1 --duration 2 --clients 100 --msg-sizes 64,256,1024 --transports tcp,tls --reuse-build --results-tag socket_default_spot_admission_multi_spot_sendsend`, `PERF_DISABLE_RESOURCE_METRICS=1 bindings/c/perf/run_benchmarks_multi.sh --pattern ALL --runs 1 --duration 1 --clients 2 --msg-sizes 64,1024,65536 --transports tcp --reuse-build --results-tag socket_default_auto_hwm_balanced_multi`, `ctest --test-dir core/build --output-on-failure`
- 실패 원인: C perf multi 공통 코드가 제거된 방향별 SpotNode HWM enum을 참조했다. `spot_routed_request_sample`은 round trip 뒤 cleanup에서 간헐적으로 timeout이 났다. perf Auto-HWM detail은 message unit refresh 뒤 relay/handle HWM을 기존 auto-HWM 값으로 다시 표시했다.
- 해결 내용: C perf는 `ZLINK_SPOT_NODE_OPT_PUBSUB_HWM`과 `ZLINK_SPOT_NODE_OPT_ROUTER_HWM`만 사용하도록 바꿨다. routed request sample은 round trip 성공 후 smoke 목적에 맞게 즉시 종료한다. Spot/SpotNode message unit refresh는 HWM 값을 바꾸지 않고 admission/relay 고정 정책을 복원하도록 수정했다.
- 결과: C sample smoke 10/10 성공, C binding ctest 10/10 성공, single perf RESULT 30/30, multi ALL RESULT 40/40, targeted SPOT RESULT 40/40, targeted SPOT_REQREP RESULT 30/30, targeted SPOT_SENDSEND RESULT 30/30, auto-HWM balanced multi RESULT 120/120. 모든 perf는 `core/build/lib/libzlink.so.5.3.4` 사용을 출력했고 fake/0-result 경로 없음. core 전체 테스트 100/100 재성공.

### 2026-05-01 12:52 KST - 단계 11

- 수정 파일: `doc/spec/core/context.md`, `doc/spec/core/context.ko.md`, `doc/spec/core/service/spot.md`, `doc/spec/core/service/spot.ko.md`, `doc/spec/core/socket/stream.ko.md`, `doc/guide/02-core-api.md`, `doc/guide/02-core-api.ko.md`, `doc/guide/03-5-stream.md`, `doc/guide/03-5-stream.ko.md`, `doc/guide/07-3-spot.md`, `doc/guide/07-3-spot.ko.md`, `doc/guide/10-performance.md`, `doc/guide/10-performance.ko.md`, `doc/guide/12-socket-options.md`, `doc/guide/12-socket-options.ko.md`, `doc/internals/socket-option-defaults.md`, `doc/internals/socket-option-defaults.ko.md`, `doc/internals/services-internals.md`, `doc/internals/services-internals.ko.md`, `doc/internals/spot-internals.md`, `doc/internals/spot-internals.ko.md`, `doc/spec/bindings/README.md`, `doc/spec/bindings/c/README.md`, `doc/spec/bindings/cpp/README.md`, `doc/spec/bindings/dotnet/README.md`, `doc/spec/bindings/go/README.md`, `doc/spec/bindings/java/README.md`, `doc/spec/bindings/node/README.md`, `doc/spec/bindings/python/README.md`, `doc/spec/bindings/rust/README.md`
- 실행 명령: `rg -n 'ZLINK_SPOT_NODE_OPT_(PUB_HWM|SUB_HWM|ROUTED_SEND_HWM|ROUTED_RECV_HWM|SUB_QUEUE_HARD_LIMIT|ROUTED_QUEUE_HARD_LIMIT)|ZLINK_SPOT_NODE_(SUB|ROUTED)_QUEUE_HARD_LIMIT_DFLT|ZLINK_SPOT_NODE_SUB_QUEUE_HARD_LIMIT_DFLT|ZLINK_SPOT_NODE_ROUTED_QUEUE_HARD_LIMIT_DFLT|SUB_QUEUE_HARD_LIMIT|ROUTED_QUEUE_HARD_LIMIT|hard limit \`100\`|routed delivery target hard limit|auto-HWM is opt-in|auto-HWM은 opt-in|auto-HWM disabled by default|auto-HWM 기본 비활성' doc/internals doc/spec doc/guide`
- 실패 원인: 정식 문서에 일반 socket HWM 기본값 `1000`, STREAM auto-HWM opt-in 설명, 기존 SpotNode 방향별 HWM option, delivery queue hard-limit option/default 설명이 남아 있었다.
- 해결 내용: context/socket/성능 가이드는 기본 auto-HWM enabled + balanced로 갱신했다. SPOT spec/guide/internals는 router/pubsub admission HWM 네 option, 숫자 override/reset/invalid 계약, relay/delivery HWM 0, hard-limit disconnect 제거, status counter ABI 호환 의미로 갱신했다. binding spec 문서는 native 동기화 기준과 언어별 노출 option을 새 public enum 기준으로 정리했다.
- 결과: 정식 문서의 제거 대상 SpotNode option/default/hard-limit 문구와 auto-HWM opt-in/기본 비활성 문구 0개.

### 2026-05-01 12:58 KST - 단계 12

- 수정 파일: `bindings/cpp/include/zlink.h`, `bindings/go/include/zlink.h`, `bindings/go/include/zlink_enum.h`, `bindings/rust/include/zlink.h`, `bindings/cpp/native/linux-x86_64/libzlink.so.5.3.4`, `bindings/dotnet/native/linux-x86_64/libzlink.so.5.3.4`, `bindings/dotnet/runtimes/linux-x64/native/libzlink.so.5.3.4`, `bindings/go/native/linux-x86_64/libzlink.so.5.3.4`, `bindings/java/native/linux-x86_64/libzlink.so.5.3.4`, `bindings/java/src/main/resources/native/linux-x86_64/libzlink.so.5.3.4`, `bindings/node/native/linux-x86_64/libzlink.so.5.3.4`, `bindings/node/prebuilds/linux-x64/libzlink.so.5.3.4`, `bindings/python/src/zlink/native/linux-x86_64/libzlink.so.5.3.4`, `bindings/rust/native/linux-x86_64/libzlink.so.5.3.4`
- 실행 명령: `cmake --build core/build`, `find bindings -maxdepth 3 -type f \( -name 'zlink.h' -o -name 'zlink_enum.h' \)`, `cp core/include/zlink.h ...`, `cp core/include/zlink_enum.h ...`, `cp core/build/lib/libzlink.so.5.3.4 ...`, `python3 - <<'PY' ... ctypes zlink_version ... PY`, `cmp -s core/include/zlink.h ...`, `cmp -s core/include/zlink_enum.h ...`
- 실패 원인: `bindings/update_zlink_libs.sh`는 release asset 동기화용이라 현재 `core/build` runtime 기준 검증 조건에 맞지 않았다.
- 해결 내용: core를 먼저 다시 빌드한 뒤 local `core/include` header와 `core/build/lib/libzlink.so.5.3.4`를 linux-x86_64 binding native/package 경로에 직접 동기화했다. 각 경로의 `libzlink.so`/`libzlink.so.5` symlink도 `5.3.4`로 맞췄다.
- 결과: cpp/go/rust header cmp 성공. cpp/dotnet/go/java/node/python/rust linux-x86_64 packaged runtime이 모두 `zlink_version 5.3.4`를 반환함.

### 2026-05-01 13:02 KST - 단계 13

- 수정 파일: `bindings/python/src/zlink/_enums.py`, `bindings/dotnet/src/Zlink/Enums.cs`
- 실행 명령: `rg -n 'SPOT_NODE_OPT_(PUB_HWM|SUB_HWM|ROUTED_SEND_HWM|ROUTED_RECV_HWM|SUB_QUEUE_HARD_LIMIT|ROUTED_QUEUE_HARD_LIMIT|ROUTER_HWM|PUBSUB_HWM)|SUB_QUEUE_HARD_LIMIT|ROUTED_QUEUE_HARD_LIMIT|PUB_HWM|ROUTED_SEND_HWM|SpotNodeOption|spotNodeOption|spot_node_option|SpotNodeOpt' bindings --glob '!**/build/**' --glob '!**/node_modules/**'`, `rg -n 'SPOT_NODE_OPT_(PUB_HWM|SUB_HWM|ROUTED_SEND_HWM|ROUTED_RECV_HWM|SUB_QUEUE_HARD_LIMIT|ROUTED_QUEUE_HARD_LIMIT)|SUB_QUEUE_HARD_LIMIT|ROUTED_QUEUE_HARD_LIMIT|PUB_HWM|SUB_HWM|ROUTED_SEND_HWM|ROUTED_RECV_HWM|PubHwm|SubHwm|RoutedSendHwm|RoutedRecvHwm|SubQueueHardLimit|RoutedQueueHardLimit|PUB_MODE|PUB_QUEUE_HWM|PUB_QUEUE_FULL_POLICY' bindings --glob '!**/build/**' --glob '!**/node_modules/**'`
- 실패 원인: Python과 .NET binding의 internal enum에 제거된 direction-based HWM과 hard-limit 값이 남아 있었다.
- 해결 내용: 두 binding enum을 public core enum 기준으로 `RouterHwmProfile`, `RouterHwm`, `PubSubHwmProfile`, `PubSubHwm` 네 값만 남기도록 갱신했다.
- 결과: binding source에서 제거 대상 SpotNode enum 이름 참조 0개. 남은 `PUBSUB_HWM` 검색 결과는 새 admission option 이름만 해당함.

### 2026-05-01 13:32 KST - 단계 14

- 수정 파일: `bindings/cpp/perf/single/src/perf_spot.cpp`, `bindings/cpp/perf/multi/common/perf_spot_control.hpp`, `bindings/cpp/perf/multi/src/perf_spot_server.cpp`, `bindings/cpp/perf/multi/src/perf_spot_client.cpp`, `bindings/cpp/perf/run_binding_single.sh`, `bindings/cpp/perf/run_binding_multi.sh`, `bindings/go/spot.go`, `bindings/go/perf/internal/perfcommon/common.go`, `bindings/go/perf/single/perf_spot.go`, `bindings/go/perf/single/perf_spot_reqrep.go`, `bindings/go/perf/multi/perf_multi_spot.go`, `bindings/go/perf/multi/perf_multi_spot_reqrep.go`, `bindings/node/native/src/addon.cc`, `bindings/node/native/src/addon_spot.cc`, `bindings/node/src/canonical.ts`, `bindings/node/perf/single/perf_single_common.ts`, `bindings/node/perf/single/perf_spot.ts`, `bindings/node/perf/single/perf_spot_reqrep.ts`, `bindings/node/perf/multi/perf_multi_runtime.ts`, `bindings/node/perf/multi/perf_multi_spot_server.ts`, `bindings/node/perf/multi/perf_multi_spot_client.ts`, `bindings/node/perf/multi/perf_multi_spot_reqrep_server.ts`, `bindings/node/perf/multi/perf_multi_spot_reqrep_client.ts`, `bindings/python/src/zlink/_ffi.py`, `bindings/python/src/zlink/_spot.py`, `bindings/python/src/zlink/_enums.py`, `bindings/python/src/zlink/__init__.py`, `bindings/python/perf/single/perf_common.py`, `bindings/python/perf/single/perf_spot.py`, `bindings/python/perf/single/perf_spot_reqrep.py`, `bindings/python/perf/multi/perf_multi_common.py`, `bindings/python/perf/multi/perf_multi_spot_server.py`, `bindings/python/perf/multi/perf_multi_spot_client.py`, `bindings/python/perf/multi/perf_multi_spot_reqrep_server.py`, `bindings/python/perf/multi/perf_multi_spot_reqrep_client.py`, `bindings/rust/src/ffi.rs`, `bindings/rust/src/service.rs`, `bindings/rust/src/ctx.rs`, `bindings/rust/perf/single/src/common.rs`, `bindings/rust/perf/single/src/perf_spot.rs`, `bindings/rust/perf/single/src/perf_spot_reqrep.rs`, `bindings/rust/perf/multi/src/perf_common.rs`, `bindings/rust/perf/multi/src/perf_multi_spot_server.rs`, `bindings/rust/perf/multi/src/perf_multi_spot_client.rs`, `bindings/rust/perf/multi/src/perf_multi_spot_reqrep_server.rs`, `bindings/rust/perf/multi/src/perf_multi_spot_reqrep_client.rs`, `bindings/dotnet/src/Zlink/Native/NativeMethods.Service.cs`, `bindings/dotnet/src/Zlink/Service/Spot.cs`, `bindings/dotnet/src/Zlink/SocketOptionFacades.cs`, `bindings/dotnet/src/Zlink/Enums.cs`
- 실행 명령: `bindings/cpp/tests/run_tests.sh`, `bindings/cpp/samples/run_samples.sh`, `bindings/cpp/perf/run_benchmarks.sh --pattern ALL ...`, `bindings/cpp/perf/run_benchmarks_multi.sh --pattern ALL ...`, `bindings/go/tests/run_tests.sh`, `bindings/go/samples/run_samples.sh`, `bindings/go/perf/run_benchmarks.sh --pattern ALL ...`, `bindings/go/perf/run_benchmarks_multi.sh --pattern ALL ...`, `bindings/java/tests/run_tests.sh`, `bindings/java/samples/run_samples.sh`, `bindings/java/perf/run_benchmarks.sh --pattern ALL ...`, `bindings/java/perf/run_benchmarks_multi.sh --pattern ALL ...`, `npm run build && npm run typecheck && npm run rebuild-native`, `bindings/node/tests/run_tests.sh`, `bindings/node/samples/run_samples.sh`, `bindings/node/perf/run_benchmarks.sh --pattern ALL ...`, `bindings/node/perf/run_benchmarks_multi.sh --pattern ALL ...`, `bindings/python/tests/run_tests.sh`, `bindings/python/samples/run_samples.sh`, `bindings/python/perf/run_benchmarks.sh --pattern ALL ...`, `bindings/python/perf/run_benchmarks_multi.sh --pattern ALL ...`, `cargo fmt && bindings/rust/tests/run_tests.sh`, `bindings/rust/samples/run_samples.sh`, `bindings/rust/perf/run_benchmarks.sh --pattern ALL ...`, `bindings/rust/perf/run_benchmarks_multi.sh --pattern ALL ...`, `bindings/dotnet/tests/run_tests.sh`, `bindings/dotnet/samples/run_samples.sh`, `bindings/dotnet/perf/run_benchmarks.sh --pattern ALL ...`, `bindings/dotnet/perf/run_benchmarks_multi.sh --pattern ALL ...`
- 실패 원인: C++/Go/Node perf가 Spot handle에 직접 HWM을 설정해 새 계약에서 invalid argument가 났다. Python/Rust/.NET wrapper에는 SpotNode admission setter가 없거나 perf가 admission을 명시하지 않았다. Go perf runner 실행 권한이 없었다. .NET sample `RegistryQuery`와 .NET single SPOT은 첫 전체 run에서 일시 실패했으나 단독 재현은 통과했다.
- 해결 내용: 각 binding에서 SpotNode router/pubsub admission HWM setter 또는 native option 연결을 추가하고, Spot perf는 Spot 생성 전에 SpotNode admission을 설정하도록 바꿨다. 제거된 SpotNode pub mode/queue policy enum은 Python/.NET에서 제거했다. Go perf runner에 실행 권한을 부여했다. .NET sample과 single perf는 전체 재실행으로 통과 상태를 확인했다.
- 결과: C++ tests 8/8, samples 11/11, single RESULT 35/35, multi RESULT 35/35. Go tests 통과, samples 11/11, single RESULT 35/35, multi RESULT 35/35. Java tests 통과, samples 11/11, single RESULT 35/35, multi RESULT 35/35. Node tests 통과, samples 11/11, single RESULT 35/35, multi RESULT 35/35. Python tests 55 passed/10 skipped, samples 11/11, single RESULT 35/35, multi RESULT 35/35. Rust tests 10/10, samples 11/11, single RESULT 35/35, multi RESULT 35/35. .NET tests 136/136, samples 11/11, single RESULT 35/35, multi RESULT 35/35.

### 2026-05-01 13:34 KST - 단계 15

- 수정 파일: `doc/plan/monitoring/socket-default-and-spot-admission-hwm-rollout-plan.ko.md`
- 실행 명령: `rg -n 'ZLINK_SPOT_NODE_OPT_(PUB_HWM|SUB_HWM|ROUTED_SEND_HWM|ROUTED_RECV_HWM|SUB_QUEUE_HARD_LIMIT|ROUTED_QUEUE_HARD_LIMIT)|SUB_QUEUE_HARD_LIMIT|ROUTED_QUEUE_HARD_LIMIT|PubHwm|SubHwm|RoutedSendHwm|RoutedRecvHwm|SubQueueHardLimit|RoutedQueueHardLimit|SpotNodePubMode|SpotNodePubQueueFullPolicy|ZLINK_SPOT_INTERNAL_.*HWM|PUB_MODE|PUB_QUEUE_HWM|PUB_QUEUE_FULL_POLICY' bindings doc/internals doc/spec doc/guide --glob '!**/build/**' --glob '!**/bin/**' --glob '!**/obj/**' --glob '!**/node_modules/**' --glob '!**/target/**'`, `rg -n 'POSD|POSD follow-up|follow-up.*POSD|followup.*POSD' core/src`, `ps -eo pid,ppid,etime,stat,cmd | rg 'bindings/.*/perf|run_benchmarks|perf_multi|perf_single|Zlink.BindingBench|node .*perf|python .*perf|target/release/perf'`
- 실패 원인: broad stale 검색에서 Node 테스트의 제거 enum 비노출 assert와 .NET 새 `PubSubHwm` 이름이 false positive로 잡혔다. perf fake 검색도 C perf runner unit test의 mock 이름이 false positive로 잡혔다.
- 해결 내용: false positive는 실제 제거 API 재도입이 아니라 테스트 assert와 새 `PubSubHwm` admission 이름임을 코드 기준으로 확인했다. 실행 중인 perf 프로세스가 없고, POSD follow-up 표식도 0개임을 확인했다.
- 결과: draft 미적용 항목 0개, POSD follow-up 0개, 제거 대상 공개 API 0개, 실행 중 perf 프로세스 0개, fake/0-result 성공 경로 없음.

### 2026-05-01 13:44 KST - 재검토 보정

- 수정 파일: `bindings/cpp/include/zlink_enum.h`, `bindings/cpp/include/zlink_errno.h`, `bindings/rust/include/zlink_enum.h`, `bindings/rust/include/zlink_errno.h`, `doc/plan/monitoring/socket-default-and-spot-admission-hwm-rollout-plan.ko.md`
- 실행 명령: `find bindings -path '*include/zlink_enum.h' -o -path '*include/zlink_errno.h' -o -path '*include/zlink.h'`, `cmp -s core/include/zlink_enum.h ...`, `cmp -s core/include/zlink_errno.h ...`, `printf '#include <zlink.h>...' | cc -I bindings/{cpp,rust,go}/include -x c -fsyntax-only -`
- 실패 원인: 재검토에서 `bindings/cpp/include/zlink.h`와 `bindings/rust/include/zlink.h`가 `zlink_enum.h`, `zlink_errno.h`를 include하지만 해당 include 디렉터리에 두 종속 헤더가 없음을 확인했다. Go include에는 이미 두 파일이 있었다.
- 해결 내용: `core/include/zlink_enum.h`와 `core/include/zlink_errno.h`를 C++/Rust include 디렉터리에 추가하고 core header와 byte-for-byte 일치 여부를 확인했다.
- 결과: C++/Go/Rust include 디렉터리 모두 `zlink.h`, `zlink_enum.h`, `zlink_errno.h`를 포함하며, `#include <zlink.h>` standalone syntax check가 세 binding include 경로에서 모두 성공했다.
