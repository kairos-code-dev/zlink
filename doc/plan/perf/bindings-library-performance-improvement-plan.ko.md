...
| 6 | Rust | `bindings/rust/perf` | `tcp/ws/wss/tls 측정 완료, routed large와 SPOT/outlier 보류 남음` | `tcp/ws/wss/tls 측정 완료, PUBSUB 전 transport 통과, SPOT small 보류 남음` | Rust 완료 아님. single outlier와 multi SPOT hot path를 후속 재검토 |
...
- **남은 보류(Rust)**: `MULTI_SPOT` ws/wss/tls 64/256/1024B, single routed large.
