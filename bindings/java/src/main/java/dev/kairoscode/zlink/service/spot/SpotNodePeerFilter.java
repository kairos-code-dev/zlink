...
public record SpotNodePeerFilter(String peerEndpoint, int source, int state) {
    MemorySegment toNative(Arena arena) {
        ...
        segment.set(ValueLayout.JAVA_INT, 256, source);
        segment.set(ValueLayout.JAVA_INT, 260, state);
        return segment;
    }
}
