...
public:
  ...
  void turn_changed (turn_changed_notify_t notify)
  {
    turns.push_back (std::move (notify));
  }

  void game_ended (game_ended_notify_t notify)
  {
    ended.push_back (std::move (notify));
  }
