...
| `PS-A4` | 구현 | `Client/Scenarios/ps-a4-subscriber-reconnect-scenario.ts` | subscriber restart 후 post-reconnect delivery와 disconnect-gap non-replay, fast subscriber 지속 수신 marker를 실제 subscriber 역할 server evidence로 확인한다. |
