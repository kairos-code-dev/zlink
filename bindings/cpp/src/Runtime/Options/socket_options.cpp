...
std::string get_pub_option_string (void *handle_, pub_option_id option_)
{
...
common_socket_options_t::common_socket_options_t (socket_t &socket_) noexcept
    : _socket (&socket_)
{
}
...
message_count_t common_socket_options_t::send_hwm () const
{
    return message_count_t::value (detail::get_common_option_value<int> (
      detail::native_option_handle (_socket),
      detail::socket_option_id::sndhwm));
}
...
message_count_t common_socket_options_t::recv_hwm () const
{
    return message_count_t::value (detail::get_common_option_value<int> (
      detail::native_option_handle (_socket),
      detail::socket_option_id::rcvhwm));
}
...
{
    detail::set_common_option_value<int> (
      detail::native_option_handle (_socket), detail::socket_option_id::ipv6,
      value ? 1 : 0);
}
...
socket_backlog_t common_socket_options_t::backlog () const
{
    return socket_backlog_t::value (detail::get_common_option_value<int> (
      detail::native_option_handle (_socket),
      detail::socket_option_id::backlog));
}
...
{
    return detail::get_common_option_string (
      detail::native_option_handle (_socket),
...
{
    return detail::get_router_option_value<int> (
             detail::native_option_handle (_socket),
...
{
    detail::set_router_option_value<int> (
      detail::native_option_handle (_socket), detail::router_option_id::probe,
      value ? 1 : 0);
}
...
std::optional<routing_id_t> router_socket_options_t::connect_routing_id () const
{
    ...
    detail::throw_if_failed<config_error_t> (static_cast<config_result_t> (
      zlink_get_router_option (detail::native_option_handle (_socket),
                               static_cast<zlink_router_option_t> (
                                 detail::router_option_id::connect_routing_id),
                               &native, &size)));
    if (native.size == 0)
        return std::nullopt;
...
void router_socket_options_t::connect_routing_id (const routing_id_t &value)
{
    ...
    detail::throw_if_failed<config_error_t> (static_cast<config_result_t> (
      zlink_set_router_option (detail::native_option_handle (_socket),
                               static_cast<zlink_router_option_t> (
                                 detail::router_option_id::connect_routing_id),
...
{
    return std::chrono::milliseconds (detail::get_router_option_value<int> (
      detail::native_option_handle (_socket),
...
{
    return detail::get_dealer_option_value<int> (
             detail::native_option_handle (_socket),
...
void dealer_socket_options_t::probe (bool value)
{
    detail::set_dealer_option_value<int> (
      detail::native_option_handle (_socket), detail::dealer_option_id::probe,
      value ? 1 : 0);
}

std::chrono::milliseconds dealer_socket_options_t::request_timeout () const
{
    return std::chrono::milliseconds (detail::get_dealer_option_value<int> (
      detail::native_option_handle (_socket),
...
{
    return peer_weight_t::value (detail::get_dealer_option_value<uint32_t> (
      detail::native_option_handle (_socket),
      detail::dealer_option_id::weight));
}
...
{
    return detail::get_stream_option_value<int> (
             detail::native_option_handle (_socket),
...
void stream_socket_options_t::notify (bool value)
{
    detail::set_stream_option_value<int> (
      detail::native_option_handle (_socket), detail::stream_option_id::notify,
      value ? 1 : 0);
}
...
void pub_socket_options_t::welcome_message (const message_t &message)
{
    detail::ensure_config_handle (detail::native_option_handle (_socket));
    detail::throw_if_failed<config_error_t> (static_cast<config_result_t> (
      zlink_set_pub_option (detail::native_option_handle (_socket),
                            ZLINK_PUB_OPT_WELCOME_MSG, message.data (),
                            message.size ())));
}
...
void pub_socket_options_t::approve_subscribe (const routing_id_t &routing_id)
{
    ...
    detail::throw_if_failed<config_error_t> (static_cast<config_result_t> (
      zlink_set_pub_option (detail::native_option_handle (_socket),
                            ZLINK_PUB_OPT_APPROVE_SUBSCRIBE, routing_id.data (),
                            routing_id.size ())));
}
...
void pub_socket_options_t::reject_subscribe (const routing_id_t &routing_id)
{
    ...
    detail::throw_if_failed<config_error_t> (static_cast<config_result_t> (
      zlink_set_pub_option (detail::native_option_handle (_socket),
                            ZLINK_PUB_OPT_REJECT_SUBSCRIBE, routing_id.data (),
                            routing_id.size ())));
}
