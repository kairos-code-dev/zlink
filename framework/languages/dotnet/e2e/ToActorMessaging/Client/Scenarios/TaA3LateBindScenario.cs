...
internal static class TaA3LateBindScenario
{
    public static async Task RunAsync(ToActorScenarioContext context)
    {
        ...
        ToActorScenarioContext.Require(beforeBind.All(snapshot => snapshot.SessionRid is null),
        ...
        ToActorScenarioContext.Require(afterBind.Count(snapshot => snapshot.SessionRid is not null) == 1,
        ...
        ToActorScenarioContext.Require(afterBind.SequenceEqual(afterNoBindCalls),
