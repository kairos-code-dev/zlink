...
@Injectable()
@zlinkSpotPacketHandler({ packetName: PacketNames.prepareInventoryReservedReq, spot: () => OrderWorkflowSpot })
class PrepareInventoryReservedHandler implements ZLinkSpotRequestHandler<OrderWorkflowSpot, StartOrderWorkflowReq, StartOrderWorkflowRes> {
  constructor(
