...
[문서 목록](../../../README.ko.md) | [이전: Session Actor Dispatch](08-actor-session.ko.md) | [다음: Location](10-location.ko.md)
<!-- framework-adapter-nav:end -->

# 9. STREAM

> 서버의 정확한 .NET 시그니처는 [STREAM session 공개 인터페이스](../../common/spec/server/languages/dotnet/interfaces/07-stream-session.ko.md)가
> 정의한다. Client package는 [.NET Stream Connector 가이드](../stream-connector/INDEX.ko.md)와
> [공개 계약](../../common/spec/stream-connector/languages/dotnet/03-stream-connector.ko.md)을 따른다.
