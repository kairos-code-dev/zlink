...
| 5 | Go | `bindings/go/perf` | `tcp single 통과, ws/wss single latency 보류, wss SPOT 262144B 미달, tls 미측정` | `미측정` | Go `wss SPOT 262144B` 개선 후 tls single 측정 |
...
| Go | 108 | 92.8% | 83.5% | 53.8% | 45.3% | 92.8% | 미측정 |
