...
- [ ] 단계 0. 실행 전 기준선 고정
- [ ] 단계 1. Peer Disconnect by Routing ID 구현, 검증, 문서 반영, 커밋과 푸시
- [ ] 단계 2. Peer Weight 구현, 검증, 문서 반영, 커밋과 푸시
- [ ] 단계 3. 자동 HWM 정책 구현, 검증, 문서 반영, 커밋과 푸시
- [ ] 단계 4. 세 기능 통합 리뷰와 누락 항목 소거
- [ ] 단계 5. 최종 전체 검증, 최종 커밋과 푸시
