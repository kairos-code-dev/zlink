    ...
    public static async Task RunAsync(ClientOptions options)
    {
        ...
        ScenarioAssert.That(
            scenarioEvidence.Any(line => line.Contains("mon-b2|duplicate=", StringComparison.Ordinal)
                && line.Contains("Duplicate monitoring socket source", StringComparison.Ordinal)),
        ...
        ScenarioAssert.That(
            scenarioEvidence.Any(line => line.Contains("mon-b2|interval=", StringComparison.Ordinal)
                && line.Contains("interval must be greater than zero", StringComparison.Ordinal)),
        ...
        ScenarioAssert.That(
            scenarioEvidence.Any(line => line.Contains("mon-b2|missing-socket=not registered", StringComparison.Ordinal)),
