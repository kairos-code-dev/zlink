...
export TICTACTOE_SG_SESSION_ROUTER_ENDPOINT="${TICTACTOE_SG_SESSION_ROUTER_ENDPOINT:-tcp://127.0.0.1:$((BASE_PORT + 5))}"
export TICTACTOE_SG_RECONNECT_SESSION_ROUTER_ENDPOINT="${TICTACTOE_SG_RECONNECT_SESSION_ROUTER_ENDPOINT:-tcp://127.0.0.1:$((BASE_PORT + 6))}"
...
export TICTACTOE_SG_PLAY_SPOT_ROUTER_ENDPOINT="${TICTACTOE_SG_PLAY_SPOT_ROUTER_ENDPOINT:-tcp://127.0.0.1:$((BASE_PORT + 11))}"
