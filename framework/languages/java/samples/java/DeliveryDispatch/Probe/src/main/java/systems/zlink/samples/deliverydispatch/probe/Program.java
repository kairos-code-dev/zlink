package systems.zlink.samples.deliverydispatch.probe;
...
import systems.zlink.samples.deliverydispatch.probe.configuration.SampleTopology;
...
public final class Program {
    ...
    public static void main(String[] args) {
        ...
        throw new IllegalStateException("Timed out waiting for DeliveryDispatch sample topology readiness.");
    }
