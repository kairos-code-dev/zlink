...
|------|--------------|----------------------|
| Unity | [`.NET`](dotnet/guide/02-unity.ko.md) | [**TypeScript**](typescript/guide/01-overview.ko.md) |
| Godot | [C++](cpp/guide/09-engine-adapters.ko.md) 또는 [C#](dotnet/guide/03-godot-csharp.ko.md) | [**TypeScript**](typescript/guide/01-overview.ko.md) |
