...
void define_spot_exports (napi_env env, napi_value exports)
{
    napi_property_descriptor descs[] = {
      ...
      ZLINK_METHOD ("spotNodeDisconnectRouterChannelPeerRid",
                    spot_node_disconnect_router_channel_peer_rid),
      ...
      ZLINK_METHOD ("spotRouteBridgeAttachDealerChannel",
                    spot_route_bridge_attach_dealer_channel),
      ZLINK_METHOD ("spotRouteBridgeAttachRouterChannel",
                    spot_route_bridge_attach_router_channel),
      ZLINK_METHOD ("spotRouteBridgeSetTargetNode", spot_route_bridge_set_target_node),
      ZLINK_METHOD ("spotRouteBridgeSend", spot_route_bridge_send),
      ZLINK_METHOD ("spotRouteBridgeRequest", spot_route_bridge_request),
      ZLINK_METHOD ("spotRouteBridgeHandleRouterReceived",
                    spot_route_bridge_handle_router_received),
      ZLINK_METHOD ("spotRouteBridgeHandleRouterReceivedWithMetadata",
                    spot_route_bridge_handle_router_received_with_metadata),
      ZLINK_METHOD ("spotRouteBridgeDrain", spot_route_bridge_drain),
      ZLINK_METHOD ("spotNodePublisherNew", spot_node_publisher_new),
      ZLINK_METHOD ("spotNodePublisherPublish", spot_node_publisher_publish),
      ZLINK_METHOD ("spotNodePublisherClose", spot_node_publisher_close),
      ZLINK_METHOD ("spotNodeProcessExternalRouter", spot_node_process_external_router),
      ZLINK_METHOD ("spotNodeTryProcessExternalRouterParts",
                    spot_node_try_process_external_router_parts),
