...
void spot_node_t::connect_router_channel_peer (const std::string &channel_name_, const std::string &endpoint_)
{
    validate_channel_name_for_connect (channel_name_);
    validate_endpoint (endpoint_);
    throw_connect_result (
      zlink_spot_node_connect_router_channel_peer (_impl->handle, channel_name_.c_str (), endpoint_.c_str ()));
}

void spot_node_t::disconnect_router_channel_peer (const std::string &channel_name_, const std::string &endpoint_)
{
    validate_channel_name_for_connect (channel_name_);
    validate_endpoint (endpoint_);
    throw_connect_result (
      zlink_spot_node_disconnect_router_channel_peer (_impl->handle, channel_name_.c_str (), endpoint_.c_str ()));
}

void spot_node_t::disconnect_router_channel_peer_rid (const std::string &channel_name_, const routing_id_t &peer_rid_)
{
    validate_channel_name_for_connect (channel_name_);
    const zlink_routing_id_t native = *zlink::detail::routing_id_native (peer_rid_);
    throw_connect_result (
      zlink_spot_node_disconnect_router_channel_peer_rid (_impl->handle, channel_name_.c_str (), &native));
}
...
void spot_node_t::attach_spot_route_channel_discovery (const std::string &channel_name_, discovery_t &discovery_)
{
    validate_channel_name (channel_name_, config_result_t::invalid_argument);
    throw_config_result (zlink_spot_node_attach_router_channel_discovery (_impl->handle, channel_name_.c_str (),
...
{
    detail::throw_if_failed<config_error_t> (static_cast<config_result_t> (zlink_spot_node_attach_channel_dealer (
      _impl->handle, zlink::detail::native_handle (discovery_), zlink::detail::native_handle (dealer_))));
}

void spot_node_t::attach_channel_dealer_manual_impl (const std::string &channel_name_, zlink::socket_t &dealer_)
{
    zlink::detail::validate_bounded_c_string (channel_name_, 255u, "channel_name");
    if (channel_name_.empty ())
...
{
    detail::throw_if_failed<config_error_t> (
      static_cast<config_result_t> (zlink_set_routing_id (_impl->handle, routing_id_.data (), routing_id_.size ())));
}
...
std::optional<actor_part_t> spot_node_t::recv_actor_part (const actor_ref_t &actor_, recv_flags_t flags_)
{
    ...
    const recv_result_t rc = static_cast<recv_result_t> (zlink_spot_node_actor_recv_part (
      zlink::detail::native_handle (*this), zlink::detail::actor_ref_native (actor_), &native_info, &native_part,
    ...
    if (!part.valid ())
        throw last_error ();
    return actor_part_t (zlink::detail::actor_model_access_t::from_native (native_info), std::move (part),
                         has_more != 0);
}

void spot_node_t::set_tls_server (const std::string &cert_, const std::string &key_, bool require_client_cert_)
{
    detail::throw_if_failed<config_error_t> (static_cast<config_result_t> (
      zlink_set_tls_server (_impl->handle, cert_.c_str (), key_.c_str (), require_client_cert_ ? 1 : 0)));
}

void spot_node_t::set_tls_client (const std::string &ca_cert_, const std::string &hostname_, bool trust_system_)
{
    const char *ca = ca_cert_.empty () ? nullptr : ca_cert_.c_str ();
    const char *hostname = hostname_.empty () ? nullptr : hostname_.c_str ();
    detail::throw_if_failed<config_error_t> (
      static_cast<config_result_t> (zlink_set_tls_client (_impl->handle, ca, hostname, trust_system_ ? 1 : 0)));
}

auto_hwm_profile spot_node_t::router_admission_hwm_profile () const
{
    return static_cast<auto_hwm_profile> (
      get_spot_node_option_int (spot_node_option (zlink::detail::spot_node_option_id::router_admission_hwm_profile)));
}

void spot_node_t::router_admission_hwm_profile (auto_hwm_profile profile_)
{
    set_spot_node_option_int (spot_node_option (zlink::detail::spot_node_option_id::router_admission_hwm_profile),
...
message_count_t spot_node_t::router_admission_hwm () const
{
    return message_count_t::value (
      get_spot_node_option_int (spot_node_option (zlink::detail::spot_node_option_id::router_admission_hwm)));
}

void spot_node_t::router_admission_hwm (message_count_t value_)
{
    set_spot_node_option_int (spot_node_option (zlink::detail::spot_node_option_id::router_admission_hwm),
                              value_.value ());
}
...
{
    return static_cast<auto_hwm_profile> (
      get_spot_node_option_int (spot_node_option (zlink::detail::spot_node_option_id::pubsub_admission_hwm_profile)));
}

void spot_node_t::pubsub_admission_hwm_profile (auto_hwm_profile profile_)
{
    set_spot_node_option_int (spot_node_option (zlink::detail::spot_node_option_id::pubsub_admission_hwm_profile),
                              static_cast<int> (profile_));
}
...
{
    return message_count_t::value (
      get_spot_node_option_int (spot_node_option (zlink::detail::spot_node_option_id::pubsub_admission_hwm)));
}

void spot_node_t::pubsub_admission_hwm (message_count_t value_)
{
    set_spot_node_option_int (spot_node_option (zlink::detail::spot_node_option_id::pubsub_admission_hwm),
                              value_.value ());
}
...
worker_count_t spot_node_t::dispatch_workers_min () const
{
    return worker_count_t::value (
      get_spot_node_option_int (spot_node_option (zlink::detail::spot_node_option_id::dispatch_workers_min)));
}

void spot_node_t::dispatch_workers_min (worker_count_t value_)
{
    set_spot_node_option_int (spot_node_option (zlink::detail::spot_node_option_id::dispatch_workers_min),
                              value_.value ());
}
...
{
    return worker_count_t::value (
      get_spot_node_option_int (spot_node_option (zlink::detail::spot_node_option_id::dispatch_workers_max)));
}

void spot_node_t::dispatch_workers_max (worker_count_t value_)
{
    set_spot_node_option_int (spot_node_option (zlink::detail::spot_node_option_id::dispatch_workers_max),
                              value_.value ());
}
...
std::vector<spot_node_peer_entry_t> spot_node_t::peers () const
{
    size_t count = 0;
    detail::throw_if_failed<config_error_t> (
      static_cast<config_result_t> (zlink_spot_node_peers (_impl->handle, nullptr, nullptr, &count)));
    std::vector<zlink_spot_node_peer_entry_t> native (count);
    if (count > 0) {
        detail::throw_if_failed<config_error_t> (
          static_cast<config_result_t> (zlink_spot_node_peers (_impl->handle, nullptr, native.data (), &count)));
        native.resize (count);
    }
...
std::vector<spot_node_peer_entry_t> spot_node_t::peers_query (const spot_node_peer_filter_t &filter_) const
{
    ...
    size_t count = 0;
    detail::throw_if_failed<config_error_t> (
      static_cast<config_result_t> (zlink_spot_node_peers (_impl->handle, &native_filter, nullptr, &count)));
    std::vector<zlink_spot_node_peer_entry_t> native (count);
    if (count > 0) {
        detail::throw_if_failed<config_error_t> (
          static_cast<config_result_t> (zlink_spot_node_peers (_impl->handle, &native_filter, native.data (), &count)));
        native.resize (count);
    }
    std::vector<spot_node_peer_entry_t> entries;
    entries.reserve (native.size ());
...
std::vector<spot_node_subject_entry_t> spot_node_t::subjects (const spot_node_subject_filter_t *filter_) const
{
    ...
    if (filter_) {
        ...
        if (filter_->subject ())
            std::snprintf (native_filter.subject, sizeof (native_filter.subject), "%s", filter_->subject ()->c_str ());
        filter_ptr = &native_filter;
    }

    size_t count = 0;
    detail::throw_if_failed<config_error_t> (
      static_cast<config_result_t> (zlink_spot_node_subjects (_impl->handle, filter_ptr, nullptr, &count)));
    std::vector<zlink_spot_node_subject_entry_t> native (count);
    if (count > 0) {
        detail::throw_if_failed<config_error_t> (
          static_cast<config_result_t> (zlink_spot_node_subjects (_impl->handle, filter_ptr, native.data (), &count)));
        native.resize (count);
    }
...
std::vector<spot_node_socket_entry_t> spot_node_t::internal_sockets (const spot_node_socket_filter_t *filter_) const
{
    ...
    size_t count = 0;
    detail::throw_if_failed<config_error_t> (
      static_cast<config_result_t> (zlink_spot_node_internal_sockets (_impl->handle, filter_ptr, nullptr, &count)));
...
actor_ref_t spot_node_t::actor_lookup (const std::string &actor_id_) const
{
    ...
    std::memset (&native, 0, sizeof (native));
    detail::throw_if_failed<config_error_t> (
      static_cast<config_result_t> (zlink_spot_node_actor_lookup (_impl->handle, actor_id_.c_str (), &native)));
    return zlink::detail::actor_model_access_t::from_native (native);
}

actor_ref_t spot_node_t::remote_actor_ref (const routing_id_t &target_node_rid_, const std::string &actor_id_)
{
    zlink::detail::validate_bounded_c_string (actor_id_, 256 - 1u, "actor_id");
    zlink_actor_ref_t native;
    std::memset (&native, 0, sizeof (native));
...
std::vector<spot_node_spot_entry_t> spot_node_t::spots () const
{
    ...
    if (count > 0) {
        detail::throw_if_failed<config_error_t> (
          static_cast<config_result_t> (zlink_spot_node_spots (_impl->handle, native.data (), &count)));
        native.resize (count);
    }
...
std::vector<spot_node_actor_entry_t> spot_node_t::actors () const
{
    ...
    if (count > 0) {
        detail::throw_if_failed<config_error_t> (
          static_cast<config_result_t> (zlink_spot_node_actors (_impl->handle, native.data (), &count)));
        native.resize (count);
    }
...
void spot_node_t::close ()
{
    ...
    detail::throw_if_failed<close_error_t> (static_cast<close_result_t> (zlink_spot_node_destroy (&tmp)));
...
std::pair<spot_t, bool> spot_node_t::get_or_create_spot (const routing_id_t &spot_rid_)
{
    void *handle = nullptr;
    uint32_t created = 0;
    detail::throw_if_failed<config_error_t> (static_cast<config_result_t> (zlink_spot_node_spot_get_or_new (
      _impl->handle, zlink::detail::routing_id_native (spot_rid_), &handle, &created)));
    return std::pair<spot_t, bool> (zlink::detail::spot_access_t::adopt_native_handle (handle), created != 0);
}
...
std::optional<spot_t> spot_node_t::spot_lookup (const routing_id_t &spot_rid_)
{
    ...
    const config_result_t rc = static_cast<config_result_t> (
      zlink_spot_node_spot_lookup (_impl->handle, zlink::detail::routing_id_native (spot_rid_), &handle));
...
int spot_node_t::get_spot_node_option_int (int option_) const
{
    ...
    detail::throw_if_failed<config_error_t> (static_cast<config_result_t> (
      zlink_get_spot_node_option (_impl->handle, static_cast<zlink_spot_node_option_t> (option_), &value, &size)));
    return value;
}

void spot_node_t::set_spot_node_option_int (int option_, int value_)
{
    detail::throw_if_failed<config_error_t> (static_cast<config_result_t> (zlink_set_spot_node_option (
