...
{
    return {std::move (packet_name), static_cast<bool> (result),
            result            ? std::string{}
...
TCallResult request_client_packet (stream_connector::connector_t &connector,
...
TCallResult send_client_packet (stream_connector::connector_t &connector,
                                TRequest request,
