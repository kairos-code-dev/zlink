...
rootProject.name = "zlink-kotlin-e2e-runtime-monitoring"
...
include(":Server:FailoverService")
include(":Server:FilteredService")
include(":Server:ThrowingService")
include(":Server:Trigger")
