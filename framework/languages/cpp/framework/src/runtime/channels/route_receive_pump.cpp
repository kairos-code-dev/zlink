...
route_receive_pump_t::route_receive_pump_t (
...
void
route_receive_pump_t::enqueue (route_received_packet_t packet)
{
  _packets.push_back (std::move (packet));
}

result_t<route_receive_result_t>
route_receive_pump_t::drain ()
{
...
std::size_t
route_receive_pump_t::pending_count () const noexcept
{
