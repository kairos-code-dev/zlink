...
| [Stream Connector 공통 스펙](../../framework/common/spec/stream-connector/32-stream-connector.ko.md) | **정본** — 대상 환경, transport, wire 계약 |

> **웹(WASM) 빌드에는 이 connector를 쓸 수 없다.** Cocos Creator web과 Godot Web은
> [TypeScript connector](../typescript/README.ko.md)를 사용한다.
