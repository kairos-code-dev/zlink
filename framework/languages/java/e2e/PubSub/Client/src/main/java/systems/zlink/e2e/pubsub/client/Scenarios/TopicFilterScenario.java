...
public final class TopicFilterScenario {
    ...
    public static void run(ScenarioContext context) {
        context.publisher().publish("alpha", new Contracts.EventNotify("ps-a2", 1, "alpha-only"));
        context.publisher().publish("beta", new Contracts.EventNotify("ps-a2", 2, "beta-only"));
        context.publisher().publish("gamma", new Contracts.EventNotify("ps-a2", 3, "gamma-only"));
