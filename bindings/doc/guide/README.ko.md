[코어 가이드](https://zlink.systems/core/ko/guide/01-overview/)
...
않도록 [코어 가이드](https://zlink.systems/core/ko/guide/01-overview/)가 한 번만 다루며, 각 언어 가이드는
...
- **메시징이 처음이다** → 코어 [개요](https://zlink.systems/core/ko/guide/01-overview/)와
  [소켓 패턴](https://zlink.systems/core/ko/guide/03-0-socket-patterns/)을 먼저 본 뒤 언어 가이드로 오세요.
...
> [코어 C API 가이드](https://zlink.systems/core/ko/guide/02-core-api/)를 봅니다.
