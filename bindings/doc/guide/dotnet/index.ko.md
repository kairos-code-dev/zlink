[바인딩 가이드](../README.ko.md) · [코어 가이드](https://kairos-code-dev.github.io/zlink/core/ko/guide/01-overview/)
...
개념은 [메시지 API](https://kairos-code-dev.github.io/zlink/core/ko/guide/09-message-api/)를 참고하세요.
...
개념과 정책은 [라우팅 ID](https://kairos-code-dev.github.io/zlink/core/ko/guide/08-routing-id/)를 참고하세요.
...
스레드 안전성 규칙은 [스레드 안전성](https://kairos-code-dev.github.io/zlink/core/ko/guide/11-thread-safety/)을 참고하세요.
...
대응합니다. 전체 C 함수 목록은 [코어 C API 가이드](https://kairos-code-dev.github.io/zlink/core/ko/guide/02-core-api/)를
참고하세요.
...
단일 스레드 소유 — 전체 규칙은 [스레드 안전성](https://kairos-code-dev.github.io/zlink/core/ko/guide/11-thread-safety/) 참고.
...
**소켓 패턴**
- [소켓 패턴 개요](https://kairos-code-dev.github.io/zlink/core/ko/guide/03-0-socket-patterns/)
  - [PAIR](https://kairos-code-dev.github.io/zlink/core/ko/guide/03-1-pair/)
  - [PUB/SUB](https://kairos-code-dev.github.io/zlink/core/ko/guide/03-2-pubsub/)
  - [DEALER](https://kairos-code-dev.github.io/zlink/core/ko/guide/03-3-dealer/)
  - [ROUTER](https://kairos-code-dev.github.io/zlink/core/ko/guide/03-4-router/)
  - [STREAM](https://kairos-code-dev.github.io/zlink/core/ko/guide/03-5-stream/)
  - [프록시](https://kairos-code-dev.github.io/zlink/core/ko/guide/03-6-proxy/)
...
**운영**
- [소켓 옵션](https://kairos-code-dev.github.io/zlink/core/ko/guide/12-socket-options/)
- [TLS 보안](https://kairos-code-dev.github.io/zlink/core/ko/guide/05-tls-security/)
- [모니터링](https://kairos-code-dev.github.io/zlink/core/ko/guide/06-monitoring/)
- [스레드 안전성](https://kairos-code-dev.github.io/zlink/core/ko/guide/11-thread-safety/)
- [메시지 API](https://kairos-code-dev.github.io/zlink/core/ko/guide/09-message-api/)
- [라우팅 ID](https://kairos-code-dev.github.io/zlink/core/ko/guide/08-routing-id/)
