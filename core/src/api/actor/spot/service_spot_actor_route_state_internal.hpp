...
struct actor_route_state_t
{
    ...
    bool find_active (const char *actor_id_, zlink_actor_route_t *route_out_) const;
    ...
    void mark_disconnected (zlink::spot_node_t *node_, const zlink_routing_id_t &target_node_rid_);
