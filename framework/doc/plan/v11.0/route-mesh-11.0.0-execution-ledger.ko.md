...
- 남은 조건은 C++ legacy public Spot manager를 exact call builder·SpotRef surface로 이관해 source operation에
  연결하는 작업, C++ 공식 provider Pending projection, Node native 두 process E2E, Redis endpoint가 필요한
