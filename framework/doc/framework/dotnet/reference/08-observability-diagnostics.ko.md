...
이 category는 trace·metric·log 기록 수준을 구성하는 `IZLinkDiagnosticsOptions`/
`IZLinkDiagnosticsRuntime`과, 모든 category의 실패를 판단하는 `ZLinkFrameworkErrorKind` 대응표를
다룬다. 정확한 signature는
[Topology monitoring exact interface](../../common/spec/server/languages/dotnet/interfaces/10-topology-monitoring.ko.md)와
[Framework 오류 exact interface](../../common/spec/server/languages/dotnet/interfaces/10-monitoring-errors.ko.md)가
소유한다.
...
전체 근거는
[Topology monitoring exact interface](../../common/spec/server/languages/dotnet/interfaces/10-topology-monitoring.ko.md)와
[Framework 오류 exact interface](../../common/spec/server/languages/dotnet/interfaces/10-monitoring-errors.ko.md)를
참고한다.
