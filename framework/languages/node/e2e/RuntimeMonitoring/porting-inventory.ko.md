...
| MON-A4 | `Client/Scenarios/MonA4AvailabilityTransitionScenario.cs` | `Client/Scenarios/mon-a4-availability-transition-scenario.ts` | done | public runtime drain/restore와 trigger socket `PeerAdmissionChanged`, service location runtime topology evidence 검증. PASS: `logs/20260703-220339-17357` |
