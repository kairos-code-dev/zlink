...
메시징 개념의 깊은 설명은 [코어 가이드](https://zlink.systems/core/ko/guide/01-overview/)가 다루며,
...
> ([스레드 안전성](https://zlink.systems/core/ko/guide/11-thread-safety/) 참고)
...
써야 합니다. ([스레드 안전성](https://zlink.systems/core/ko/guide/11-thread-safety/) 참고)
