...
| 11 | 2026-04-23 | `request_completion::drain()`에서 pending이 없을 때 불필요하게 signal socket을 계속 두드리던 경로를 줄이고, `zlink_spot_request_progress_internal()`에서 benchmark와 무관한 channel-reply bridge 경로를 `channel_reply_sources`가 없으면 바로 건너뛰게 했다. `SPOT_SENDSEND` client에서는 `send blocked`를 progress로 치지 않도록 정리했다 | direct-route smoke는 계속 통과했다. `SPOT_REQREP tcp 64B clients=100 duration=2s` 단독 기본값은 [perf_c_multi_linux_20260423_192924.txt](/home/hep7/project/kairos/zlink/bindings/c/perf/results/multi/report/perf_c_multi_linux_20260423_192924.txt)에서 `102.098 Kops/s`, 다시 확인한 최신 값은 [perf_c_multi_linux_20260423_193213.txt](/home/hep7/project/kairos/zlink/bindings/c/perf/results/multi/report/perf_c_multi_linux_20260423_193213.txt)에서 `100.446 Kops/s`였다. `SPOT_SENDSEND` 단독은 [perf_c_multi_linux_20260423_193226.txt](/home/hep7/project/kairos/zlink/bindings/c/perf/results/multi/report/perf_c_multi_linux_20260423_193226.txt)에서 `167.492 Kops/s`, `io_threads=8/8`에서는 [perf_c_multi_linux_20260423_193326.txt](/home/hep7/project/kairos/zlink/bindings/c/perf/results/multi/report/perf_c_multi_linux_20260423_193326.txt) 기준 `167.694 Kops/s`로 거의 차이가 없었다. `--hwm 1000`은 [perf_c_multi_linux_20260423_193248.txt](/home/hep7/project/kairos/zlink/bindings/c/perf/results/multi/report/perf_c_multi_linux_20260423_193248.txt)에서 `163.541 Kops/s`, `--sndbuf 1m --rcvbuf 1m`은 [perf_c_multi_linux_20260423_193258.txt](/home/hep7/project/kairos/zlink/bindings/c/perf/results/multi/report/perf_c_multi_linux_20260423_193258.txt)에서 `166.313 Kops/s`였다. combined run은 [perf_c_multi_linux_20260423_193048.txt](/home/hep7/project/kairos/zlink/bindings/c/perf/results/multi/report/perf_c_multi_linux_20260423_193048.txt)에서 `SPOT_SENDSEND 169.929 Kops/s / SPOT_REQREP 86.216 Kops/s`, 순서를 바꾼 [perf_c_multi_linux_20260423_193110.txt](/home/hep7/project/kairos/zlink/bindings/c/perf/results/multi/report/perf_c_multi_linux_20260423_193110.txt)에서는 `SPOT_SENDSEND 163.741 Kops/s / SPOT_REQREP 91.494 Kops/s`였다 | `REQREP`는 기본 조건에서 다시 `100 Kops/s`를 넘겼고, 현재 병목은 timeout/completion fast path보다 더 깊은 req/rep bookkeeping 또는 runner 상태 영향으로 좁혀졌다. `SENDSEND`는 지금 코드와 기본 옵션에서 `165~170 Kops/s`대가 현실선이고, `HWM`/버퍼/`io_threads` 조정은 큰 도움이 되지 않았다. 다음 라운드는 `SENDSEND` local delivery hot path나 server echo backpressure 처리 쪽을 직접 줄여야 `200 Kops/s`에 더 가까워질 수 있다 |
| 12 | 2026-04-23 | `SPOT_REQREP` 완료 경로를 타는 poller hot path를 다시 정리했다. 먼저 perf client/server의 trace env lookup을 정적으로 캐시했지만 유의미한 차이는 없었다. 이어서 `zlink_poller_wait_all()`에서 per-call `native_events` 벡터를 새로 만들지 않고 poller handle 안의 재사용 버퍼를 쓰게 했고, native event를 public event로 바꿀 때 registration을 다시 선형 탐색하지 않도록 `registration index map`과 direct fill helper를 추가했다 | direct-route smoke는 계속 통과했다. env lookup 캐시는 [perf_c_multi_linux_20260423_215939.txt](/home/hep7/project/kairos/zlink/bindings/c/perf/results/multi/report/perf_c_multi_linux_20260423_215939.txt) `SPOT_REQREP 194.081 Kops/s`, [perf_c_multi_linux_20260423_215949.txt](/home/hep7/project/kairos/zlink/bindings/c/perf/results/multi/report/perf_c_multi_linux_20260423_215949.txt) `SPOT_SENDSEND 230.787 Kops/s`로 거의 제자리였다. benchmark 공통 timestamp를 `steady_clock`로 바꾸는 실험은 [perf_c_multi_linux_20260423_220236.txt](/home/hep7/project/kairos/zlink/bindings/c/perf/results/multi/report/perf_c_multi_linux_20260423_220236.txt) `193.363 Kops/s`, [perf_c_multi_linux_20260423_220242.txt](/home/hep7/project/kairos/zlink/bindings/c/perf/results/multi/report/perf_c_multi_linux_20260423_220242.txt) `223.649 Kops/s`로 회귀해서 폐기했다. poller 재사용 버퍼와 direct registration lookup까지 적용한 뒤에는 [perf_c_multi_linux_20260423_220810.txt](/home/hep7/project/kairos/zlink/bindings/c/perf/results/multi/report/perf_c_multi_linux_20260423_220810.txt)에서 `SPOT_REQREP 203.427 Kops/s`, [perf_c_multi_linux_20260423_220817.txt](/home/hep7/project/kairos/zlink/bindings/c/perf/results/multi/report/perf_c_multi_linux_20260423_220817.txt)에서 `SPOT_SENDSEND 238.305 Kops/s`가 나왔다 | `REQREP`는 드디어 기본 조건 `tcp 64B clients=100 duration=2s`에서 `200 Kops/s`를 넘겼다. 이번 상승폭은 client loop 미세 조정보다 core poller wrapper의 allocation/lookup churn이 실제 병목이었다는 뜻이다. `SENDSEND`도 회귀 없이 `238 Kops/s`를 유지했다. 다음 라운드는 이 상태를 기준으로 `SENDSEND 250+`와 `REQREP 210+`를 노릴 수 있는 추가 poller churn 또는 direct send envelope 비용 축소를 검토하면 된다 |
| 13 | 2026-04-23 | POSD 기준 잔여 구조를 다시 정리했다. `spot_request_reply_state_t`와 `router_spot_request_reply_state_t`의 giant alias를 걷어내고 `requests/recv/completion_state/dispatch` 하위 상태만 남겼다. routed recv queue/signal, channel reply source는 helper를 통해서만 접근하게 바꿨고, registry에서 dispatch task/state create 경로를 [service_spot_request_reply_lifecycle.cpp](/home/hep7/project/kairos/zlink/core/src/api/service_spot_request_reply_lifecycle.cpp)로 분리했다. routed codec은 packed/legacy parse helper로 쪼갰고, routed delivery는 remote execution helper를 따로 뒀다. perf harness도 giant lambda를 helper 함수로 나눠 active loop와 event handling을 분리했다 | `ctest --output-on-failure -R test_multi_spot_benchmark_process -j1`는 최종 재실행 기준 통과했다. direct-route smoke 두 개도 같은 binary 안에서 계속 통과했다. 구조 정리 뒤 순차 측정한 `SPOT_REQREP` 최신값은 [perf_c_multi_linux_20260423_223147.txt](/home/hep7/project/kairos/zlink/bindings/c/perf/results/multi/report/perf_c_multi_linux_20260423_223147.txt) `208.161 Kops/s`, `SPOT_SENDSEND` 최신값은 [perf_c_multi_linux_20260423_223156.txt](/home/hep7/project/kairos/zlink/bindings/c/perf/results/multi/report/perf_c_multi_linux_20260423_223156.txt) `243.664 Kops/s`였다. 중간에 전체 process regression이 한 번 `many_clients_tcp_large_sequence`에서 fail 했지만 같은 build 상태로 재실행하면 통과했고, direct-route smoke에는 영향이 없었다 | 이번 라운드의 구조 변경은 성능 하락 없이 유지 가능하다. `REQREP`는 `203 -> 208 Kops/s`로 조금 더 올랐고, `SENDSEND`도 `238 -> 243 Kops/s`로 회복됐다. 남은 POSD 잔여물은 timeout ownership 이원화와 local recv surface의 internal pair queue 의미 축소처럼 더 큰 구조 변경 쪽이다 |
